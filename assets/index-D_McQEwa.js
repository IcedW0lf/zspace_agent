...
`)+`
`+c);const _=g+p+o,T=g+c+a,D=Lp(r,r.VERTEX_SHADER,_),C=Lp(r,r.FRAGMENT_SHADER,T);r.attachShader(S,D),r.attachShader(S,C),n.index0AttributeName!==void 0?r.bindAttribLocation(S,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(S,0,"position"),r.linkProgram(S);function A(R){if(t.debug.checkShaderErrors){const W=r.getProgramInfoLog(S).trim(),U=r.getShaderInfoLog(D).trim(),K=r.getShaderInfoLog(C).trim();let X=!0,O=!0;if(r.getProgramParameter(S,r.LINK_STATUS)===!1)if(X=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,S,D,C);else{const $=Dp(r,D,"vertex"),b=Dp(r,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(S,r.VALIDATE_STATUS)+`
