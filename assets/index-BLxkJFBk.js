 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(b,Y){var Z=b.length;b.push(Y);e:for(;0<Z;){var Q=Z-1>>>1,ge=b[Q];if(0<r(ge,Y))b[Q]=Y,b[Z]=ge,Z=Q;else break e}}function n(b){return b.length===0?null:b[0]}function i(b){if(b.length===0)return null;var Y=b[0],Z=b.pop();if(Z!==Y){b[0]=Z;e:for(var Q=0,ge=b.length,Ee=ge>>>1;Q<Ee;){var V=2*(Q+1)-1,ee=b[V],ce=V+1,ue=b[ce];if(0>r(ee,Z))ce<ge&&0>r(ue,ee)?(b[Q]=ue,b[ce]=Z,Q=ce):(b[Q]=ee,b[V]=Z,Q=V);else if(ce<ge&&0>r(ue,Z))b[Q]=ue,b[ce]=Z,Q=ce;else break e}}return Y}function r(b,Y){var Z=b.sortIndex-Y.sortIndex;return Z!==0?Z:b.id-Y.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],u=[],f=1,h=null,d=3,m=!1,x=!1,S=!1,p=typeof setTimeout=="function"?setTimeout:null,c=typeof clearTimeout=="function"?clearTimeout:null,g=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function _(b){for(var Y=n(u);Y!==null;){if(Y.callback===null)i(u);else if(Y.startTime<=b)i(u),Y.sortIndex=Y.expirationTime,e(l,Y);else break;Y=n(u)}}function T(b){if(S=!1,_(b),!x)if(n(l)!==null)x=!0,O(D);else{var Y=n(u);Y!==null&&$(T,Y.startTime-b)}}function D(b,Y){x=!1,S&&(S=!1,c(I),I=-1),m=!0;var Z=d;try{for(_(Y),h=n(l);h!==null&&(!(h.expirationTime>Y)||b&&!R());){var Q=h.callback;if(typeof Q=="function"){h.callback=null,d=h.priorityLevel;var ge=Q(h.expirationTime<=Y);Y=t.unstable_now(),typeof ge=="function"?h.callback=ge:h===n(l)&&i(l),_(Y)}else i(l);h=n(l)}if(h!==null)var Ee=!0;else{var V=n(u);V!==null&&$(T,V.startTime-Y),Ee=!1}return Ee}finally{h=null,d=Z,m=!1}}var C=!1,A=null,I=-1,M=5,v=-1;function R(){return!(t.unstable_now()-v<M)}function X(){if(A!==null){var b=t.unstable_now();v=b;var Y=!0;try{Y=A(!0,b)}finally{Y?U():(C=!1,A=null)}}else C=!1}var U;if(typeof g=="function")U=function(){g(X)};else if(typeof MessageChannel<"u"){var K=new MessageChannel,j=K.port2;K.port1.onmessage=X,U=function(){j.postMessage(null)}}else U=function(){p(X,0)};function O(b){A=b,C||(C=!0,U())}function $(b,Y){I=p(function(){b(t.unstable_now())},Y)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(b){b.callback=null},t.unstable_continueExecution=function(){x||m||(x=!0,O(D))},t.unstable_forceFrameRate=function(b){0>b||125<b?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):M=0<b?Math.floor(1e3/b):5},t.unstable_getCurrentPriorityLevel=function(){return d},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(b){switch(d){case 1:case 2:case 3:var Y=3;break;default:Y=d}var Z=d;d=Y;try{return b()}finally{d=Z}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(b,Y){switch(b){case 1:case 2:case 3:case 4:case 5:break;default:b=3}var Z=d;d=b;try{return Y()}finally{d=Z}},t.unstable_scheduleCallback=function(b,Y,Z){var Q=t.unstable_now();switch(typeof Z=="object"&&Z!==null?(Z=Z.delay,Z=typeof Z=="number"&&0<Z?Q+Z:Q):Z=Q,b){case 1:var ge=-1;break;case 2:ge=250;break;case 5:ge=1073741823;break;case 4:ge=1e4;break;default:ge=5e3}return ge=Z+ge,b={id:f++,callback:Y,priorityLevel:b,startTime:Z,expirationTime:ge,sortIndex:-1},Z>Q?(b.sortIndex=Z,e(u,b),n(l)===null&&b===n(u)&&(S?(c(I),I=-1):S=!0,$(T,Z-Q))):(b.sortIndex=ge,e(l,b),x||m||(x=!0,O(D))),b},t.unstable_shouldYield=R,t.unstable_wrapCallback=function(b){var Y=d;return function(){var Z=d;d=Y;try{return b.apply(this,arguments)}finally{d=Z}}}})(fm);cm.exports=fm;var gv=cm.exports;/**
 * @license React
...
`)+`
`+c);const _=g+p+o,T=g+c+a,D=Lp(r,r.VERTEX_SHADER,_),C=Lp(r,r.FRAGMENT_SHADER,T);r.attachShader(S,D),r.attachShader(S,C),n.index0AttributeName!==void 0?r.bindAttribLocation(S,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(S,0,"position"),r.linkProgram(S);function A(R){if(t.debug.checkShaderErrors){const X=r.getProgramInfoLog(S).trim(),U=r.getShaderInfoLog(D).trim(),K=r.getShaderInfoLog(C).trim();let j=!0,O=!0;if(r.getProgramParameter(S,r.LINK_STATUS)===!1)if(j=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,S,D,C);else{const $=Dp(r,D,"vertex"),b=Dp(r,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(S,r.VALIDATE_STATUS)+`
...
}`;function dw(t,e,n){let i=new bd;const r=new Ue,s=new Ue,o=new wt,a=new lw({depthPacking:oy}),l=new uw,u={},f=n.maxTextureSize,h={[ji]:nn,[nn]:ji,[Wn]:Wn},d=new Yi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ue},radius:{value:4}},vertexShader:cw,fragmentShader:fw}),m=d.clone();m.defines.HORIZONTAL_PASS=1;const x=new gi;x.setAttribute("position",new En(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const S=new jn(x,d),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=c_;let c=this.type;this.render=function(C,A,I){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||C.length===0)return;const M=t.getRenderTarget(),v=t.getActiveCubeFace(),R=t.getActiveMipmapLevel(),X=t.state;X.setBlending(Vi),X.buffers.color.setClear(1,1,1,1),X.buffers.depth.setTest(!0),X.setScissorTest(!1);const U=c!==ni&&this.type===ni,K=c===ni&&this.type!==ni;for(let j=0,O=C.length;j<O;j++){const $=C[j],b=$.shadow;if(b===void 0){console.warn("THREE.WebGLShadowMap:",$,"has no shadow.");continue}if(b.autoUpdate===!1&&b.needsUpdate===!1)continue;r.copy(b.mapSize);const Y=b.getFrameExtents();if(r.multiply(Y),s.copy(b.mapSize),(r.x>f||r.y>f)&&(r.x>f&&(s.x=Math.floor(f/Y.x),r.x=s.x*Y.x,b.mapSize.x=s.x),r.y>f&&(s.y=Math.floor(f/Y.y),r.y=s.y*Y.y,b.mapSize.y=s.y)),b.map===null||U===!0||K===!0){const Q=this.type!==ni?{minFilter:Sn,magFilter:Sn}:{};b.map!==null&&b.map.dispose(),b.map=new Tr(r.x,r.y,Q),b.map.texture.name=$.name+".shadowMap",b.camera.updateProjectionMatrix()}t.setRenderTarget(b.map),t.clear();const Z=b.getViewportCount();for(let Q=0;Q<Z;Q++){const ge=b.getViewport(Q);o.set(s.x*ge.x,s.y*ge.y,s.x*ge.z,s.y*ge.w),X.viewport(o),b.updateMatrices($,Q),i=b.getFrustum(),T(A,I,b.camera,$,this.type)}b.isPointLightShadow!==!0&&this.type===ni&&g(b,I),b.needsUpdate=!1}c=this.type,p.needsUpdate=!1,t.setRenderTarget(M,v,R)};function g(C,A){const I=e.update(S);d.defines.VSM_SAMPLES!==C.blurSamples&&(d.defines.VSM_SAMPLES=C.blurSamples,m.defines.VSM_SAMPLES=C.blurSamples,d.needsUpdate=!0,m.needsUpdate=!0),C.mapPass===null&&(C.mapPass=new Tr(r.x,r.y)),d.uniforms.shadow_pass.value=C.map.texture,d.uniforms.resolution.value=C.mapSize,d.uniforms.radius.value=C.radius,t.setRenderTarget(C.mapPass),t.clear(),t.renderBufferDirect(A,null,I,d,S,null),m.uniforms.shadow_pass.value=C.mapPass.texture,m.uniforms.resolution.value=C.mapSize,m.uniforms.radius.value=C.radius,t.setRenderTarget(C.map),t.clear(),t.renderBufferDirect(A,null,I,m,S,null)}function _(C,A,I,M){let v=null;const R=I.isPointLight===!0?C.customDistanceMaterial:C.customDepthMaterial;if(R!==void 0)v=R;else if(v=I.isPointLight===!0?l:a,t.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0){const X=v.uuid,U=A.uuid;let K=u[X];K===void 0&&(K={},u[X]=K);let j=K[U];j===void 0&&(j=v.clone(),K[U]=j,A.addEventListener("dispose",D)),v=j}if(v.visible=A.visible,v.wireframe=A.wireframe,M===ni?v.side=A.shadowSide!==null?A.shadowSide:A.side:v.side=A.shadowSide!==null?A.shadowSide:h[A.side],v.alphaMap=A.alphaMap,v.alphaTest=A.alphaTest,v.map=A.map,v.clipShadows=A.clipShadows,v.clippingPlanes=A.clippingPlanes,v.clipIntersection=A.clipIntersection,v.displacementMap=A.displacementMap,v.displacementScale=A.displacementScale,v.displacementBias=A.displacementBias,v.wireframeLinewidth=A.wireframeLinewidth,v.linewidth=A.linewidth,I.isPointLight===!0&&v.isMeshDistanceMaterial===!0){const X=t.properties.get(v);X.light=I}return v}function T(C,A,I,M,v){if(C.visible===!1)return;if(C.layers.test(A.layers)&&(C.isMesh||C.isLine||C.isPoints)&&(C.castShadow||C.receiveShadow&&v===ni)&&(!C.frustumCulled||i.intersectsObject(C))){C.modelViewMatrix.multiplyMatrices(I.matrixWorldInverse,C.matrixWorld);const U=e.update(C),K=C.material;if(Array.isArray(K)){const j=U.groups;for(let O=0,$=j.length;O<$;O++){const b=j[O],Y=K[b.materialIndex];if(Y&&Y.visible){const Z=_(C,Y,M,v);C.onBeforeShadow(t,C,A,I,U,Z,b),t.renderBufferDirect(I,null,U,Z,C,b),C.onAfterShadow(t,C,A,I,U,Z,b)}}}else if(K.visible){const j=_(C,K,M,v);C.onBeforeShadow(t,C,A,I,U,j,null),t.renderBufferDirect(I,null,U,j,C,null),C.onAfterShadow(t,C,A,I,U,j,null)}}const X=C.children;for(let U=0,K=X.length;U<K;U++)T(X[U],A,I,M,v)}function D(C){C.target.removeEventListener("dispose",D);for(const I in u){const M=u[I],v=C.target.uuid;v in M&&(M[v].dispose(),delete M[v])}}}function hw(t){function e(){let y=!1;const z=new wt;let B=null;const q=new wt(0,0,0,0);return{setMask:function(ne){B!==ne&&!y&&(t.colorMask(ne,ne,ne,ne),B=ne)},setLocked:function(ne){y=ne},setClear:function(ne,ye,Re,mt,St){St===!0&&(ne*=mt,ye*=mt,Re*=mt),z.set(ne,ye,Re,mt),q.equals(z)===!1&&(t.clearColor(ne,ye,Re,mt),q.copy(z))},reset:function(){y=!1,B=null,q.set(-1,0,0,0)}}}function n(){let y=!1,z=null,B=null,q=null;return{setTest:function(ne){ne?ce(t.DEPTH_TEST):ue(t.DEPTH_TEST)},setMask:function(ne){z!==ne&&!y&&(t.depthMask(ne),z=ne)},setFunc:function(ne){if(B!==ne){switch(ne){case Vx:t.depthFunc(t.NEVER);break;case Gx:t.depthFunc(t.ALWAYS);break;case Wx:t.depthFunc(t.LESS);break;case _l:t.depthFunc(t.LEQUAL);break;case Xx:t.depthFunc(t.EQUAL);break;case jx:t.depthFunc(t.GEQUAL);break;case Yx:t.depthFunc(t.GREATER);break;case qx:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}B=ne}},setLocked:function(ne){y=ne},setClear:function(ne){q!==ne&&(t.clearDepth(ne),q=ne)},reset:function(){y=!1,z=null,B=null,q=null}}}function i(){let y=!1,z=null,B=null,q=null,ne=null,ye=null,Re=null,mt=null,St=null;return{setTest:function(Ge){y||(Ge?ce(t.STENCIL_TEST):ue(t.STENCIL_TEST))},setMask:function(Ge){z!==Ge&&!y&&(t.stencilMask(Ge),z=Ge)},setFunc:function(Ge,Mt,_t){(B!==Ge||q!==Mt||ne!==_t)&&(t.stencilFunc(Ge,Mt,_t),B=Ge,q=Mt,ne=_t)},setOp:function(Ge,Mt,_t){(ye!==Ge||Re!==Mt||mt!==_t)&&(t.stencilOp(Ge,Mt,_t),ye=Ge,Re=Mt,mt=_t)},setLocked:function(Ge){y=Ge},setClear:function(Ge){St!==Ge&&(t.clearStencil(Ge),St=Ge)},reset:function(){y=!1,z=null,B=null,q=null,ne=null,ye=null,Re=null,mt=null,St=null}}}const r=new e,s=new n,o=new i,a=new WeakMap,l=new WeakMap;let u={},f={},h=new WeakMap,d=[],m=null,x=!1,S=null,p=null,c=null,g=null,_=null,T=null,D=null,C=new Ve(0,0,0),A=0,I=!1,M=null,v=null,R=null,X=null,U=null;const K=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let j=!1,O=0;const $=t.getParameter(t.VERSION);$.indexOf("WebGL")!==-1?(O=parseFloat(/^WebGL (\d)/.exec($)[1]),j=O>=1):$.indexOf("OpenGL ES")!==-1&&(O=parseFloat(/^OpenGL ES (\d)/.exec($)[1]),j=O>=2);let b=null,Y={};const Z=t.getParameter(t.SCISSOR_BOX),Q=t.getParameter(t.VIEWPORT),ge=new wt().fromArray(Z),Ee=new wt().fromArray(Q);function V(y,z,B,q){const ne=new Uint8Array(4),ye=t.createTexture();t.bindTexture(y,ye),t.texParameteri(y,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(y,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let Re=0;Re<B;Re++)y===t.TEXTURE_3D||y===t.TEXTURE_2D_ARRAY?t.texImage3D(z,0,t.RGBA,1,1,q,0,t.RGBA,t.UNSIGNED_BYTE,ne):t.texImage2D(z+Re,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,ne);return ye}const ee={};ee[t.TEXTURE_2D]=V(t.TEXTURE_2D,t.TEXTURE_2D,1),ee[t.TEXTURE_CUBE_MAP]=V(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),ee[t.TEXTURE_2D_ARRAY]=V(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),ee[t.TEXTURE_3D]=V(t.TEXTURE_3D,t.TEXTURE_3D,1,1),r.setClear(0,0,0,1),s.setClear(1),o.setClear(0),ce(t.DEPTH_TEST),s.setFunc(_l),je(!1),xe(Xh),ce(t.CULL_FACE),ut(Vi);function ce(y){u[y]!==!0&&(t.enable(y),u[y]=!0)}function ue(y){u[y]!==!1&&(t.disable(y),u[y]=!1)}function be(y,z){return f[y]!==z?(t.bindFramebuffer(y,z),f[y]=z,y===t.DRAW_FRAMEBUFFER&&(f[t.FRAMEBUFFER]=z),y===t.FRAMEBUFFER&&(f[t.DRAW_FRAMEBUFFER]=z),!0):!1}function Fe(y,z){let B=d,q=!1;if(y){B=h.get(z),B===void 0&&(B=[],h.set(z,B));const ne=y.textures;if(B.length!==ne.length||B[0]!==t.COLOR_ATTACHMENT0){for(let ye=0,Re=ne.length;ye<Re;ye++)B[ye]=t.COLOR_ATTACHMENT0+ye;B.length=ne.length,q=!0}}else B[0]!==t.BACK&&(B[0]=t.BACK,q=!0);q&&t.drawBuffers(B)}function ze(y){return m!==y?(t.useProgram(y),m=y,!0):!1}const Je={[lr]:t.FUNC_ADD,[wx]:t.FUNC_SUBTRACT,[Ax]:t.FUNC_REVERSE_SUBTRACT};Je[Cx]=t.MIN,Je[Rx]=t.MAX;const L={[Px]:t.ZERO,[bx]:t.ONE,[Lx]:t.SRC_COLOR,[Wc]:t.SRC_ALPHA,[Ox]:t.SRC_ALPHA_SATURATE,[Nx]:t.DST_COLOR,[Ix]:t.DST_ALPHA,[Dx]:t.ONE_MINUS_SRC_COLOR,[Xc]:t.ONE_MINUS_SRC_ALPHA,[Fx]:t.ONE_MINUS_DST_COLOR,[Ux]:t.ONE_MINUS_DST_ALPHA,[kx]:t.CONSTANT_COLOR,[zx]:t.ONE_MINUS_CONSTANT_COLOR,[Bx]:t.CONSTANT_ALPHA,[Hx]:t.ONE_MINUS_CONSTANT_ALPHA};function ut(y,z,B,q,ne,ye,Re,mt,St,Ge){if(y===Vi){x===!0&&(ue(t.BLEND),x=!1);return}if(x===!1&&(ce(t.BLEND),x=!0),y!==Tx){if(y!==S||Ge!==I){if((p!==lr||_!==lr)&&(t.blendEquation(t.FUNC_ADD),p=lr,_=lr),Ge)switch(y){case ms:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case jh:t.blendFunc(t.ONE,t.ONE);break;case Yh:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case qh:t.blendFuncSeparate(t.ZERO,t.SRC_COLOR,t.ZERO,t.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",y);break}else switch(y){case ms:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case jh:t.blendFunc(t.SRC_ALPHA,t.ONE);break;case Yh:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case qh:t.blendFunc(t.ZERO,t.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",y);break}c=null,g=null,T=null,D=null,C.set(0,0,0),A=0,S=y,I=Ge}return}ne=ne||z,ye=ye||B,Re=Re||q,(z!==p||ne!==_)&&(t.blendEquationSeparate(Je[z],Je[ne]),p=z,_=ne),(B!==c||q!==g||ye!==T||Re!==D)&&(t.blendFuncSeparate(L[B],L[q],L[ye],L[Re]),c=B,g=q,T=ye,D=Re),(mt.equals(C)===!1||St!==A)&&(t.blendColor(mt.r,mt.g,mt.b,St),C.copy(mt),A=St),S=y,I=!1}function Xe(y,z){y.side===Wn?ue(t.CULL_FACE):ce(t.CULL_FACE);let B=y.side===nn;z&&(B=!B),je(B),y.blending===ms&&y.transparent===!1?ut(Vi):ut(y.blending,y.blendEquation,y.blendSrc,y.blendDst,y.blendEquationAlpha,y.blendSrcAlpha,y.blendDstAlpha,y.blendColor,y.blendAlpha,y.premultipliedAlpha),s.setFunc(y.depthFunc),s.setTest(y.depthTest),s.setMask(y.depthWrite),r.setMask(y.colorWrite);const q=y.stencilWrite;o.setTest(q),q&&(o.setMask(y.stencilWriteMask),o.setFunc(y.stencilFunc,y.stencilRef,y.stencilFuncMask),o.setOp(y.stencilFail,y.stencilZFail,y.stencilZPass)),Le(y.polygonOffset,y.polygonOffsetFactor,y.polygonOffsetUnits),y.alphaToCoverage===!0?ce(t.SAMPLE_ALPHA_TO_COVERAGE):ue(t.SAMPLE_ALPHA_TO_COVERAGE)}function je(y){M!==y&&(y?t.frontFace(t.CW):t.frontFace(t.CCW),M=y)}function xe(y){y!==Sx?(ce(t.CULL_FACE),y!==v&&(y===Xh?t.cullFace(t.BACK):y===Mx?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):ue(t.CULL_FACE),v=y}function ct(y){y!==R&&(j&&t.lineWidth(y),R=y)}function Le(y,z,B){y?(ce(t.POLYGON_OFFSET_FILL),(X!==z||U!==B)&&(t.polygonOffset(z,B),X=z,U=B)):ue(t.POLYGON_OFFSET_FILL)}function Ie(y){y?ce(t.SCISSOR_TEST):ue(t.SCISSOR_TEST)}function P(y){y===void 0&&(y=t.TEXTURE0+K-1),b!==y&&(t.activeTexture(y),b=y)}function E(y,z,B){B===void 0&&(b===null?B=t.TEXTURE0+K-1:B=b);let q=Y[B];q===void 0&&(q={type:void 0,texture:void 0},Y[B]=q),(q.type!==y||q.texture!==z)&&(b!==B&&(t.activeTexture(B),b=B),t.bindTexture(y,z||ee[y]),q.type=y,q.texture=z)}function W(){const y=Y[b];y!==void 0&&y.type!==void 0&&(t.bindTexture(y.type,null),y.type=void 0,y.texture=void 0)}function te(){try{t.compressedTexImage2D.apply(t,arguments)}catch(y){console.error("THREE.WebGLState:",y)}}function ie(){try{t.compressedTexImage3D.apply(t,arguments)}catch(y){console.error("THREE.WebGLState:",y)}}function J(){try{t.texSubImage2D.apply(t,arguments)}catch(y){console.error("THREE.WebGLState:",y)}}function Me(){try{t.texSubImage3D.apply(t,arguments)}catch(y){console.error("THREE.WebGLState:",y)}}function ae(){try{t.compressedTexSubImage2D.apply(t,arguments)}catch(y){console.error("THREE.WebGLState:",y)}}function de(){try{t.compressedTexSubImage3D.apply(t,arguments)}catch(y){console.error("THREE.WebGLState:",y)}}function Ne(){try{t.texStorage2D.apply(t,arguments)}catch(y){console.error("THREE.WebGLState:",y)}}function se(){try{t.texStorage3D.apply(t,arguments)}catch(y){console.error("THREE.WebGLState:",y)}}function he(){try{t.texImage2D.apply(t,arguments)}catch(y){console.error("THREE.WebGLState:",y)}}function He(){try{t.texImage3D.apply(t,arguments)}catch(y){console.error("THREE.WebGLState:",y)}}function we(y){ge.equals(y)===!1&&(t.scissor(y.x,y.y,y.z,y.w),ge.copy(y))}function me(y){Ee.equals(y)===!1&&(t.viewport(y.x,y.y,y.z,y.w),Ee.copy(y))}function Ce(y,z){let B=l.get(z);B===void 0&&(B=new WeakMap,l.set(z,B));let q=B.get(y);q===void 0&&(q=t.getUniformBlockIndex(z,y.name),B.set(y,q))}function De(y,z){const q=l.get(z).get(y);a.get(z)!==q&&(t.uniformBlockBinding(z,q,y.__bindingPointIndex),a.set(z,q))}function rt(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),u={},b=null,Y={},f={},h=new WeakMap,d=[],m=null,x=!1,S=null,p=null,c=null,g=null,_=null,T=null,D=null,C=new Ve(0,0,0),A=0,I=!1,M=null,v=null,R=null,X=null,U=null,ge.set(0,0,t.canvas.width,t.canvas.height),Ee.set(0,0,t.canvas.width,t.canvas.height),r.reset(),s.reset(),o.reset()}return{buffers:{color:r,depth:s,stencil:o},enable:ce,disable:ue,bindFramebuffer:be,drawBuffers:Fe,useProgram:ze,setBlending:ut,setMaterial:Xe,setFlipSided:je,setCullFace:xe,setLineWidth:ct,setPolygonOffset:Le,setScissorTest:Ie,activeTexture:P,bindTexture:E,unbindTexture:W,compressedTexImage2D:te,compressedTexImage3D:ie,texImage2D:he,texImage3D:He,updateUBOMapping:Ce,uniformBlockBinding:De,texStorage2D:Ne,texStorage3D:se,texSubImage2D:J,texSubImage3D:Me,compressedTexSubImage2D:ae,compressedTexSubImage3D:de,scissor:we,viewport:me,reset:rt}}function Bp(t,e,n,i){const r=pw(i);switch(n){case m_:return t*e;case __:return t*e;case v_:return t*e*2;case x_:return t*e/r.components*r.byteLength;case wd:return t*e/r.components*r.byteLength;case y_:return t*e*2/r.components*r.byteLength;case Ad:return t*e*2/r.components*r.byteLength;case g_:return t*e*3/r.components*r.byteLength;case Nn:return t*e*4/r.components*r.byteLength;case Cd:return t*e*4/r.components*r.byteLength;case Ba:case Ha:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*8;case Va:case Ga:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*16;case Zc:case Jc:return Math.max(t,16)*Math.max(e,8)/4;case $c:case Qc:return Math.max(t,8)*Math.max(e,8)/2;case ef:case tf:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*8;case nf:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*16;case rf:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*16;case sf:return Math.floor((t+4)/5)*Math.floor((e+3)/4)*16;case of:return Math.floor((t+4)/5)*Math.floor((e+4)/5)*16;case af:return Math.floor((t+5)/6)*Math.floor((e+4)/5)*16;case lf:return Math.floor((t+5)/6)*Math.floor((e+5)/6)*16;case uf:return Math.floor((t+7)/8)*Math.floor((e+4)/5)*16;case cf:return Math.floor((t+7)/8)*Math.floor((e+5)/6)*16;case ff:return Math.floor((t+7)/8)*Math.floor((e+7)/8)*16;case df:return Math.floor((t+9)/10)*Math.floor((e+4)/5)*16;case hf:return Math.floor((t+9)/10)*Math.floor((e+5)/6)*16;case pf:return Math.floor((t+9)/10)*Math.floor((e+7)/8)*16;case mf:return Math.floor((t+9)/10)*Math.floor((e+9)/10)*16;case gf:return Math.floor((t+11)/12)*Math.floor((e+9)/10)*16;case _f:return Math.floor((t+11)/12)*Math.floor((e+11)/12)*16;case Wa:case vf:case xf:return Math.ceil(t/4)*Math.ceil(e/4)*16;case S_:case yf:return Math.ceil(t/4)*Math.ceil(e/4)*8;case Sf:case Mf:return Math.ceil(t/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${n} format.`)}function pw(t){switch(t){case pi:case d_:return{byteLength:1,components:1};case Co:case h_:case Io:return{byteLength:2,components:1};case Ed:case Td:return{byteLength:2,components:4};case Er:case Md:case ai:return{byteLength:4,components:1};case p_:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${t}.`)}function mw(t,e,n,i,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),u=new Ue,f=new WeakMap;let h;const d=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function x(P,E){return m?new OffscreenCanvas(P,E):Ml("canvas")}function S(P,E,W){let te=1;const ie=Ie(P);if((ie.width>W||ie.height>W)&&(te=W/Math.max(ie.width,ie.height)),te<1)if(typeof HTMLImageElement<"u"&&P instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&P instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&P instanceof ImageBitmap||typeof VideoFrame<"u"&&P instanceof VideoFrame){const J=Math.floor(te*ie.width),Me=Math.floor(te*ie.height);h===void 0&&(h=x(J,Me));const ae=E?x(J,Me):h;return ae.width=J,ae.height=Me,ae.getContext("2d").drawImage(P,0,0,J,Me),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+ie.width+"x"+ie.height+") to ("+J+"x"+Me+")."),ae}else return"data"in P&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+ie.width+"x"+ie.height+")."),P;return P}function p(P){return P.generateMipmaps&&P.minFilter!==Sn&&P.minFilter!==Un}function c(P){t.generateMipmap(P)}function g(P,E,W,te,ie=!1){if(P!==null){if(t[P]!==void 0)return t[P];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+P+"'")}let J=E;if(E===t.RED&&(W===t.FLOAT&&(J=t.R32F),W===t.HALF_FLOAT&&(J=t.R16F),W===t.UNSIGNED_BYTE&&(J=t.R8)),E===t.RED_INTEGER&&(W===t.UNSIGNED_BYTE&&(J=t.R8UI),W===t.UNSIGNED_SHORT&&(J=t.R16UI),W===t.UNSIGNED_INT&&(J=t.R32UI),W===t.BYTE&&(J=t.R8I),W===t.SHORT&&(J=t.R16I),W===t.INT&&(J=t.R32I)),E===t.RG&&(W===t.FLOAT&&(J=t.RG32F),W===t.HALF_FLOAT&&(J=t.RG16F),W===t.UNSIGNED_BYTE&&(J=t.RG8)),E===t.RG_INTEGER&&(W===t.UNSIGNED_BYTE&&(J=t.RG8UI),W===t.UNSIGNED_SHORT&&(J=t.RG16UI),W===t.UNSIGNED_INT&&(J=t.RG32UI),W===t.BYTE&&(J=t.RG8I),W===t.SHORT&&(J=t.RG16I),W===t.INT&&(J=t.RG32I)),E===t.RGB&&W===t.UNSIGNED_INT_5_9_9_9_REV&&(J=t.RGB9_E5),E===t.RGBA){const Me=ie?vl:$e.getTransfer(te);W===t.FLOAT&&(J=t.RGBA32F),W===t.HALF_FLOAT&&(J=t.RGBA16F),W===t.UNSIGNED_BYTE&&(J=Me===nt?t.SRGB8_ALPHA8:t.RGBA8),W===t.UNSIGNED_SHORT_4_4_4_4&&(J=t.RGBA4),W===t.UNSIGNED_SHORT_5_5_5_1&&(J=t.RGB5_A1)}return(J===t.R16F||J===t.R32F||J===t.RG16F||J===t.RG32F||J===t.RGBA16F||J===t.RGBA32F)&&e.get("EXT_color_buffer_float"),J}function _(P,E){let W;return P?E===null||E===Er||E===Cs?W=t.DEPTH24_STENCIL8:E===ai?W=t.DEPTH32F_STENCIL8:E===Co&&(W=t.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):E===null||E===Er||E===Cs?W=t.DEPTH_COMPONENT24:E===ai?W=t.DEPTH_COMPONENT32F:E===Co&&(W=t.DEPTH_COMPONENT16),W}function T(P,E){return p(P)===!0||P.isFramebufferTexture&&P.minFilter!==Sn&&P.minFilter!==Un?Math.log2(Math.max(E.width,E.height))+1:P.mipmaps!==void 0&&P.mipmaps.length>0?P.mipmaps.length:P.isCompressedTexture&&Array.isArray(P.image)?E.mipmaps.length:1}function D(P){const E=P.target;E.removeEventListener("dispose",D),A(E),E.isVideoTexture&&f.delete(E)}function C(P){const E=P.target;E.removeEventListener("dispose",C),M(E)}function A(P){const E=i.get(P);if(E.__webglInit===void 0)return;const W=P.source,te=d.get(W);if(te){const ie=te[E.__cacheKey];ie.usedTimes--,ie.usedTimes===0&&I(P),Object.keys(te).length===0&&d.delete(W)}i.remove(P)}function I(P){const E=i.get(P);t.deleteTexture(E.__webglTexture);const W=P.source,te=d.get(W);delete te[E.__cacheKey],o.memory.textures--}function M(P){const E=i.get(P);if(P.depthTexture&&P.depthTexture.dispose(),P.isWebGLCubeRenderTarget)for(let te=0;te<6;te++){if(Array.isArray(E.__webglFramebuffer[te]))for(let ie=0;ie<E.__webglFramebuffer[te].length;ie++)t.deleteFramebuffer(E.__webglFramebuffer[te][ie]);else t.deleteFramebuffer(E.__webglFramebuffer[te]);E.__webglDepthbuffer&&t.deleteRenderbuffer(E.__webglDepthbuffer[te])}else{if(Array.isArray(E.__webglFramebuffer))for(let te=0;te<E.__webglFramebuffer.length;te++)t.deleteFramebuffer(E.__webglFramebuffer[te]);else t.deleteFramebuffer(E.__webglFramebuffer);if(E.__webglDepthbuffer&&t.deleteRenderbuffer(E.__webglDepthbuffer),E.__webglMultisampledFramebuffer&&t.deleteFramebuffer(E.__webglMultisampledFramebuffer),E.__webglColorRenderbuffer)for(let te=0;te<E.__webglColorRenderbuffer.length;te++)E.__webglColorRenderbuffer[te]&&t.deleteRenderbuffer(E.__webglColorRenderbuffer[te]);E.__webglDepthRenderbuffer&&t.deleteRenderbuffer(E.__webglDepthRenderbuffer)}const W=P.textures;for(let te=0,ie=W.length;te<ie;te++){const J=i.get(W[te]);J.__webglTexture&&(t.deleteTexture(J.__webglTexture),o.memory.textures--),i.remove(W[te])}i.remove(P)}let v=0;function R(){v=0}function X(){const P=v;return P>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+P+" texture units while this GPU supports only "+r.maxTextures),v+=1,P}function U(P){const E=[];return E.push(P.wrapS),E.push(P.wrapT),E.push(P.wrapR||0),E.push(P.magFilter),E.push(P.minFilter),E.push(P.anisotropy),E.push(P.internalFormat),E.push(P.format),E.push(P.type),E.push(P.generateMipmaps),E.push(P.premultiplyAlpha),E.push(P.flipY),E.push(P.unpackAlignment),E.push(P.colorSpace),E.join()}function K(P,E){const W=i.get(P);if(P.isVideoTexture&&ct(P),P.isRenderTargetTexture===!1&&P.version>0&&W.__version!==P.version){const te=P.image;if(te===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(te.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Ee(W,P,E);return}}n.bindTexture(t.TEXTURE_2D,W.__webglTexture,t.TEXTURE0+E)}function j(P,E){const W=i.get(P);if(P.version>0&&W.__version!==P.version){Ee(W,P,E);return}n.bindTexture(t.TEXTURE_2D_ARRAY,W.__webglTexture,t.TEXTURE0+E)}function O(P,E){const W=i.get(P);if(P.version>0&&W.__version!==P.version){Ee(W,P,E);return}n.bindTexture(t.TEXTURE_3D,W.__webglTexture,t.TEXTURE0+E)}function $(P,E){const W=i.get(P);if(P.version>0&&W.__version!==P.version){V(W,P,E);return}n.bindTexture(t.TEXTURE_CUBE_MAP,W.__webglTexture,t.TEXTURE0+E)}const b={[qc]:t.REPEAT,[hr]:t.CLAMP_TO_EDGE,[Kc]:t.MIRRORED_REPEAT},Y={[Sn]:t.NEAREST,[ry]:t.NEAREST_MIPMAP_NEAREST,[na]:t.NEAREST_MIPMAP_LINEAR,[Un]:t.LINEAR,[xu]:t.LINEAR_MIPMAP_NEAREST,[pr]:t.LINEAR_MIPMAP_LINEAR},Z={[ly]:t.NEVER,[py]:t.ALWAYS,[uy]:t.LESS,[E_]:t.LEQUAL,[cy]:t.EQUAL,[hy]:t.GEQUAL,[fy]:t.GREATER,[dy]:t.NOTEQUAL};function Q(P,E){if(E.type===ai&&e.has("OES_texture_float_linear")===!1&&(E.magFilter===Un||E.magFilter===xu||E.magFilter===na||E.magFilter===pr||E.minFilter===Un||E.minFilter===xu||E.minFilter===na||E.minFilter===pr)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),t.texParameteri(P,t.TEXTURE_WRAP_S,b[E.wrapS]),t.texParameteri(P,t.TEXTURE_WRAP_T,b[E.wrapT]),(P===t.TEXTURE_3D||P===t.TEXTURE_2D_ARRAY)&&t.texParameteri(P,t.TEXTURE_WRAP_R,b[E.wrapR]),t.texParameteri(P,t.TEXTURE_MAG_FILTER,Y[E.magFilter]),t.texParameteri(P,t.TEXTURE_MIN_FILTER,Y[E.minFilter]),E.compareFunction&&(t.texParameteri(P,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(P,t.TEXTURE_COMPARE_FUNC,Z[E.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(E.magFilter===Sn||E.minFilter!==na&&E.minFilter!==pr||E.type===ai&&e.has("OES_texture_float_linear")===!1)return;if(E.anisotropy>1||i.get(E).__currentAnisotropy){const W=e.get("EXT_texture_filter_anisotropic");t.texParameterf(P,W.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(E.anisotropy,r.getMaxAnisotropy())),i.get(E).__currentAnisotropy=E.anisotropy}}}function ge(P,E){let W=!1;P.__webglInit===void 0&&(P.__webglInit=!0,E.addEventListener("dispose",D));const te=E.source;let ie=d.get(te);ie===void 0&&(ie={},d.set(te,ie));const J=U(E);if(J!==P.__cacheKey){ie[J]===void 0&&(ie[J]={texture:t.createTexture(),usedTimes:0},o.memory.textures++,W=!0),ie[J].usedTimes++;const Me=ie[P.__cacheKey];Me!==void 0&&(ie[P.__cacheKey].usedTimes--,Me.usedTimes===0&&I(E)),P.__cacheKey=J,P.__webglTexture=ie[J].texture}return W}function Ee(P,E,W){let te=t.TEXTURE_2D;(E.isDataArrayTexture||E.isCompressedArrayTexture)&&(te=t.TEXTURE_2D_ARRAY),E.isData3DTexture&&(te=t.TEXTURE_3D);const ie=ge(P,E),J=E.source;n.bindTexture(te,P.__webglTexture,t.TEXTURE0+W);const Me=i.get(J);if(J.version!==Me.__version||ie===!0){n.activeTexture(t.TEXTURE0+W);const ae=$e.getPrimaries($e.workingColorSpace),de=E.colorSpace===Li?null:$e.getPrimaries(E.colorSpace),Ne=E.colorSpace===Li||ae===de?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,E.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,E.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ne);let se=S(E.image,!1,r.maxTextureSize);se=Le(E,se);const he=s.convert(E.format,E.colorSpace),He=s.convert(E.type);let we=g(E.internalFormat,he,He,E.colorSpace,E.isVideoTexture);Q(te,E);let me;const Ce=E.mipmaps,De=E.isVideoTexture!==!0,rt=Me.__version===void 0||ie===!0,y=J.dataReady,z=T(E,se);if(E.isDepthTexture)we=_(E.format===Rs,E.type),rt&&(De?n.texStorage2D(t.TEXTURE_2D,1,we,se.width,se.height):n.texImage2D(t.TEXTURE_2D,0,we,se.width,se.height,0,he,He,null));else if(E.isDataTexture)if(Ce.length>0){De&&rt&&n.texStorage2D(t.TEXTURE_2D,z,we,Ce[0].width,Ce[0].height);for(let B=0,q=Ce.length;B<q;B++)me=Ce[B],De?y&&n.texSubImage2D(t.TEXTURE_2D,B,0,0,me.width,me.height,he,He,me.data):n.texImage2D(t.TEXTURE_2D,B,we,me.width,me.height,0,he,He,me.data);E.generateMipmaps=!1}else De?(rt&&n.texStorage2D(t.TEXTURE_2D,z,we,se.width,se.height),y&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,se.width,se.height,he,He,se.data)):n.texImage2D(t.TEXTURE_2D,0,we,se.width,se.height,0,he,He,se.data);else if(E.isCompressedTexture)if(E.isCompressedArrayTexture){De&&rt&&n.texStorage3D(t.TEXTURE_2D_ARRAY,z,we,Ce[0].width,Ce[0].height,se.depth);for(let B=0,q=Ce.length;B<q;B++)if(me=Ce[B],E.format!==Nn)if(he!==null)if(De){if(y)if(E.layerUpdates.size>0){const ne=Bp(me.width,me.height,E.format,E.type);for(const ye of E.layerUpdates){const Re=me.data.subarray(ye*ne/me.data.BYTES_PER_ELEMENT,(ye+1)*ne/me.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,B,0,0,ye,me.width,me.height,1,he,Re,0,0)}E.clearLayerUpdates()}else n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,B,0,0,0,me.width,me.height,se.depth,he,me.data,0,0)}else n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,B,we,me.width,me.height,se.depth,0,me.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else De?y&&n.texSubImage3D(t.TEXTURE_2D_ARRAY,B,0,0,0,me.width,me.height,se.depth,he,He,me.data):n.texImage3D(t.TEXTURE_2D_ARRAY,B,we,me.width,me.height,se.depth,0,he,He,me.data)}else{De&&rt&&n.texStorage2D(t.TEXTURE_2D,z,we,Ce[0].width,Ce[0].height);for(let B=0,q=Ce.length;B<q;B++)me=Ce[B],E.format!==Nn?he!==null?De?y&&n.compressedTexSubImage2D(t.TEXTURE_2D,B,0,0,me.width,me.height,he,me.data):n.compressedTexImage2D(t.TEXTURE_2D,B,we,me.width,me.height,0,me.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):De?y&&n.texSubImage2D(t.TEXTURE_2D,B,0,0,me.width,me.height,he,He,me.data):n.texImage2D(t.TEXTURE_2D,B,we,me.width,me.height,0,he,He,me.data)}else if(E.isDataArrayTexture)if(De){if(rt&&n.texStorage3D(t.TEXTURE_2D_ARRAY,z,we,se.width,se.height,se.depth),y)if(E.layerUpdates.size>0){const B=Bp(se.width,se.height,E.format,E.type);for(const q of E.layerUpdates){const ne=se.data.subarray(q*B/se.data.BYTES_PER_ELEMENT,(q+1)*B/se.data.BYTES_PER_ELEMENT);n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,q,se.width,se.height,1,he,He,ne)}E.clearLayerUpdates()}else n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,se.width,se.height,se.depth,he,He,se.data)}else n.texImage3D(t.TEXTURE_2D_ARRAY,0,we,se.width,se.height,se.depth,0,he,He,se.data);else if(E.isData3DTexture)De?(rt&&n.texStorage3D(t.TEXTURE_3D,z,we,se.width,se.height,se.depth),y&&n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,se.width,se.height,se.depth,he,He,se.data)):n.texImage3D(t.TEXTURE_3D,0,we,se.width,se.height,se.depth,0,he,He,se.data);else if(E.isFramebufferTexture){if(rt)if(De)n.texStorage2D(t.TEXTURE_2D,z,we,se.width,se.height);else{let B=se.width,q=se.height;for(let ne=0;ne<z;ne++)n.texImage2D(t.TEXTURE_2D,ne,we,B,q,0,he,He,null),B>>=1,q>>=1}}else if(Ce.length>0){if(De&&rt){const B=Ie(Ce[0]);n.texStorage2D(t.TEXTURE_2D,z,we,B.width,B.height)}for(let B=0,q=Ce.length;B<q;B++)me=Ce[B],De?y&&n.texSubImage2D(t.TEXTURE_2D,B,0,0,he,He,me):n.texImage2D(t.TEXTURE_2D,B,we,he,He,me);E.generateMipmaps=!1}else if(De){if(rt){const B=Ie(se);n.texStorage2D(t.TEXTURE_2D,z,we,B.width,B.height)}y&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,he,He,se)}else n.texImage2D(t.TEXTURE_2D,0,we,he,He,se);p(E)&&c(te),Me.__version=J.version,E.onUpdate&&E.onUpdate(E)}P.__version=E.version}function V(P,E,W){if(E.image.length!==6)return;const te=ge(P,E),ie=E.source;n.bindTexture(t.TEXTURE_CUBE_MAP,P.__webglTexture,t.TEXTURE0+W);const J=i.get(ie);if(ie.version!==J.__version||te===!0){n.activeTexture(t.TEXTURE0+W);const Me=$e.getPrimaries($e.workingColorSpace),ae=E.colorSpace===Li?null:$e.getPrimaries(E.colorSpace),de=E.colorSpace===Li||Me===ae?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,E.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,E.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,de);const Ne=E.isCompressedTexture||E.image[0].isCompressedTexture,se=E.image[0]&&E.image[0].isDataTexture,he=[];for(let q=0;q<6;q++)!Ne&&!se?he[q]=S(E.image[q],!0,r.maxCubemapSize):he[q]=se?E.image[q].image:E.image[q],he[q]=Le(E,he[q]);const He=he[0],we=s.convert(E.format,E.colorSpace),me=s.convert(E.type),Ce=g(E.internalFormat,we,me,E.colorSpace),De=E.isVideoTexture!==!0,rt=J.__version===void 0||te===!0,y=ie.dataReady;let z=T(E,He);Q(t.TEXTURE_CUBE_MAP,E);let B;if(Ne){De&&rt&&n.texStorage2D(t.TEXTURE_CUBE_MAP,z,Ce,He.width,He.height);for(let q=0;q<6;q++){B=he[q].mipmaps;for(let ne=0;ne<B.length;ne++){const ye=B[ne];E.format!==Nn?we!==null?De?y&&n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+q,ne,0,0,ye.width,ye.height,we,ye.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+q,ne,Ce,ye.width,ye.height,0,ye.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):De?y&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+q,ne,0,0,ye.width,ye.height,we,me,ye.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+q,ne,Ce,ye.width,ye.height,0,we,me,ye.data)}}}else{if(B=E.mipmaps,De&&rt){B.length>0&&z++;const q=Ie(he[0]);n.texStorage2D(t.TEXTURE_CUBE_MAP,z,Ce,q.width,q.height)}for(let q=0;q<6;q++)if(se){De?y&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+q,0,0,0,he[q].width,he[q].height,we,me,he[q].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+q,0,Ce,he[q].width,he[q].height,0,we,me,he[q].data);for(let ne=0;ne<B.length;ne++){const Re=B[ne].image[q].image;De?y&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+q,ne+1,0,0,Re.width,Re.height,we,me,Re.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+q,ne+1,Ce,Re.width,Re.height,0,we,me,Re.data)}}else{De?y&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+q,0,0,0,we,me,he[q]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+q,0,Ce,we,me,he[q]);for(let ne=0;ne<B.length;ne++){const ye=B[ne];De?y&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+q,ne+1,0,0,we,me,ye.image[q]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+q,ne+1,Ce,we,me,ye.image[q])}}}p(E)&&c(t.TEXTURE_CUBE_MAP),J.__version=ie.version,E.onUpdate&&E.onUpdate(E)}P.__version=E.version}function ee(P,E,W,te,ie,J){const Me=s.convert(W.format,W.colorSpace),ae=s.convert(W.type),de=g(W.internalFormat,Me,ae,W.colorSpace);if(!i.get(E).__hasExternalTextures){const se=Math.max(1,E.width>>J),he=Math.max(1,E.height>>J);ie===t.TEXTURE_3D||ie===t.TEXTURE_2D_ARRAY?n.texImage3D(ie,J,de,se,he,E.depth,0,Me,ae,null):n.texImage2D(ie,J,de,se,he,0,Me,ae,null)}n.bindFramebuffer(t.FRAMEBUFFER,P),xe(E)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,te,ie,i.get(W).__webglTexture,0,je(E)):(ie===t.TEXTURE_2D||ie>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&ie<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,te,ie,i.get(W).__webglTexture,J),n.bindFramebuffer(t.FRAMEBUFFER,null)}function ce(P,E,W){if(t.bindRenderbuffer(t.RENDERBUFFER,P),E.depthBuffer){const te=E.depthTexture,ie=te&&te.isDepthTexture?te.type:null,J=_(E.stencilBuffer,ie),Me=E.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ae=je(E);xe(E)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,ae,J,E.width,E.height):W?t.renderbufferStorageMultisample(t.RENDERBUFFER,ae,J,E.width,E.height):t.renderbufferStorage(t.RENDERBUFFER,J,E.width,E.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,Me,t.RENDERBUFFER,P)}else{const te=E.textures;for(let ie=0;ie<te.length;ie++){const J=te[ie],Me=s.convert(J.format,J.colorSpace),ae=s.convert(J.type),de=g(J.internalFormat,Me,ae,J.colorSpace),Ne=je(E);W&&xe(E)===!1?t.renderbufferStorageMultisample(t.RENDERBUFFER,Ne,de,E.width,E.height):xe(E)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,Ne,de,E.width,E.height):t.renderbufferStorage(t.RENDERBUFFER,de,E.width,E.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function ue(P,E){if(E&&E.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(n.bindFramebuffer(t.FRAMEBUFFER,P),!(E.depthTexture&&E.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!i.get(E.depthTexture).__webglTexture||E.depthTexture.image.width!==E.width||E.depthTexture.image.height!==E.height)&&(E.depthTexture.image.width=E.width,E.depthTexture.image.height=E.height,E.depthTexture.needsUpdate=!0),K(E.depthTexture,0);const te=i.get(E.depthTexture).__webglTexture,ie=je(E);if(E.depthTexture.format===gs)xe(E)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,te,0,ie):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,te,0);else if(E.depthTexture.format===Rs)xe(E)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,te,0,ie):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,te,0);else throw new Error("Unknown depthTexture format")}function be(P){const E=i.get(P),W=P.isWebGLCubeRenderTarget===!0;if(P.depthTexture&&!E.__autoAllocateDepthBuffer){if(W)throw new Error("target.depthTexture not supported in Cube render targets");ue(E.__webglFramebuffer,P)}else if(W){E.__webglDepthbuffer=[];for(let te=0;te<6;te++)n.bindFramebuffer(t.FRAMEBUFFER,E.__webglFramebuffer[te]),E.__webglDepthbuffer[te]=t.createRenderbuffer(),ce(E.__webglDepthbuffer[te],P,!1)}else n.bindFramebuffer(t.FRAMEBUFFER,E.__webglFramebuffer),E.__webglDepthbuffer=t.createRenderbuffer(),ce(E.__webglDepthbuffer,P,!1);n.bindFramebuffer(t.FRAMEBUFFER,null)}function Fe(P,E,W){const te=i.get(P);E!==void 0&&ee(te.__webglFramebuffer,P,P.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),W!==void 0&&be(P)}function ze(P){const E=P.texture,W=i.get(P),te=i.get(E);P.addEventListener("dispose",C);const ie=P.textures,J=P.isWebGLCubeRenderTarget===!0,Me=ie.length>1;if(Me||(te.__webglTexture===void 0&&(te.__webglTexture=t.createTexture()),te.__version=E.version,o.memory.textures++),J){W.__webglFramebuffer=[];for(let ae=0;ae<6;ae++)if(E.mipmaps&&E.mipmaps.length>0){W.__webglFramebuffer[ae]=[];for(let de=0;de<E.mipmaps.length;de++)W.__webglFramebuffer[ae][de]=t.createFramebuffer()}else W.__webglFramebuffer[ae]=t.createFramebuffer()}else{if(E.mipmaps&&E.mipmaps.length>0){W.__webglFramebuffer=[];for(let ae=0;ae<E.mipmaps.length;ae++)W.__webglFramebuffer[ae]=t.createFramebuffer()}else W.__webglFramebuffer=t.createFramebuffer();if(Me)for(let ae=0,de=ie.length;ae<de;ae++){const Ne=i.get(ie[ae]);Ne.__webglTexture===void 0&&(Ne.__webglTexture=t.createTexture(),o.memory.textures++)}if(P.samples>0&&xe(P)===!1){W.__webglMultisampledFramebuffer=t.createFramebuffer(),W.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,W.__webglMultisampledFramebuffer);for(let ae=0;ae<ie.length;ae++){const de=ie[ae];W.__webglColorRenderbuffer[ae]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,W.__webglColorRenderbuffer[ae]);const Ne=s.convert(de.format,de.colorSpace),se=s.convert(de.type),he=g(de.internalFormat,Ne,se,de.colorSpace,P.isXRRenderTarget===!0),He=je(P);t.renderbufferStorageMultisample(t.RENDERBUFFER,He,he,P.width,P.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+ae,t.RENDERBUFFER,W.__webglColorRenderbuffer[ae])}t.bindRenderbuffer(t.RENDERBUFFER,null),P.depthBuffer&&(W.__webglDepthRenderbuffer=t.createRenderbuffer(),ce(W.__webglDepthRenderbuffer,P,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(J){n.bindTexture(t.TEXTURE_CUBE_MAP,te.__webglTexture),Q(t.TEXTURE_CUBE_MAP,E);for(let ae=0;ae<6;ae++)if(E.mipmaps&&E.mipmaps.length>0)for(let de=0;de<E.mipmaps.length;de++)ee(W.__webglFramebuffer[ae][de],P,E,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+ae,de);else ee(W.__webglFramebuffer[ae],P,E,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0);p(E)&&c(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(Me){for(let ae=0,de=ie.length;ae<de;ae++){const Ne=ie[ae],se=i.get(Ne);n.bindTexture(t.TEXTURE_2D,se.__webglTexture),Q(t.TEXTURE_2D,Ne),ee(W.__webglFramebuffer,P,Ne,t.COLOR_ATTACHMENT0+ae,t.TEXTURE_2D,0),p(Ne)&&c(t.TEXTURE_2D)}n.unbindTexture()}else{let ae=t.TEXTURE_2D;if((P.isWebGL3DRenderTarget||P.isWebGLArrayRenderTarget)&&(ae=P.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(ae,te.__webglTexture),Q(ae,E),E.mipmaps&&E.mipmaps.length>0)for(let de=0;de<E.mipmaps.length;de++)ee(W.__webglFramebuffer[de],P,E,t.COLOR_ATTACHMENT0,ae,de);else ee(W.__webglFramebuffer,P,E,t.COLOR_ATTACHMENT0,ae,0);p(E)&&c(ae),n.unbindTexture()}P.depthBuffer&&be(P)}function Je(P){const E=P.textures;for(let W=0,te=E.length;W<te;W++){const ie=E[W];if(p(ie)){const J=P.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:t.TEXTURE_2D,Me=i.get(ie).__webglTexture;n.bindTexture(J,Me),c(J),n.unbindTexture()}}}const L=[],ut=[];function Xe(P){if(P.samples>0){if(xe(P)===!1){const E=P.textures,W=P.width,te=P.height;let ie=t.COLOR_BUFFER_BIT;const J=P.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,Me=i.get(P),ae=E.length>1;if(ae)for(let de=0;de<E.length;de++)n.bindFramebuffer(t.FRAMEBUFFER,Me.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+de,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,Me.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+de,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,Me.__webglMultisampledFramebuffer),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,Me.__webglFramebuffer);for(let de=0;de<E.length;de++){if(P.resolveDepthBuffer&&(P.depthBuffer&&(ie|=t.DEPTH_BUFFER_BIT),P.stencilBuffer&&P.resolveStencilBuffer&&(ie|=t.STENCIL_BUFFER_BIT)),ae){t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,Me.__webglColorRenderbuffer[de]);const Ne=i.get(E[de]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,Ne,0)}t.blitFramebuffer(0,0,W,te,0,0,W,te,ie,t.NEAREST),l===!0&&(L.length=0,ut.length=0,L.push(t.COLOR_ATTACHMENT0+de),P.depthBuffer&&P.resolveDepthBuffer===!1&&(L.push(J),ut.push(J),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,ut)),t.invalidateFramebuffer(t.READ_FRAMEBUFFER,L))}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),ae)for(let de=0;de<E.length;de++){n.bindFramebuffer(t.FRAMEBUFFER,Me.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+de,t.RENDERBUFFER,Me.__webglColorRenderbuffer[de]);const Ne=i.get(E[de]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,Me.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+de,t.TEXTURE_2D,Ne,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,Me.__webglMultisampledFramebuffer)}else if(P.depthBuffer&&P.resolveDepthBuffer===!1&&l){const E=P.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[E])}}}function je(P){return Math.min(r.maxSamples,P.samples)}function xe(P){const E=i.get(P);return P.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&E.__useRenderToTexture!==!1}function ct(P){const E=o.render.frame;f.get(P)!==E&&(f.set(P,E),P.update())}function Le(P,E){const W=P.colorSpace,te=P.format,ie=P.type;return P.isCompressedTexture===!0||P.isVideoTexture===!0||W!==Zi&&W!==Li&&($e.getTransfer(W)===nt?(te!==Nn||ie!==pi)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",W)),E}function Ie(P){return typeof HTMLImageElement<"u"&&P instanceof HTMLImageElement?(u.width=P.naturalWidth||P.width,u.height=P.naturalHeight||P.height):typeof VideoFrame<"u"&&P instanceof VideoFrame?(u.width=P.displayWidth,u.height=P.displayHeight):(u.width=P.width,u.height=P.height),u}this.allocateTextureUnit=X,this.resetTextureUnits=R,this.setTexture2D=K,this.setTexture2DArray=j,this.setTexture3D=O,this.setTextureCube=$,this.rebindTextures=Fe,this.setupRenderTarget=ze,this.updateRenderTargetMipmap=Je,this.updateMultisampleRenderTarget=Xe,this.setupDepthRenderbuffer=be,this.setupFrameBufferTexture=ee,this.useMultisampledRTT=xe}function gw(t,e){function n(i,r=Li){let s;const o=$e.getTransfer(r);if(i===pi)return t.UNSIGNED_BYTE;if(i===Ed)return t.UNSIGNED_SHORT_4_4_4_4;if(i===Td)return t.UNSIGNED_SHORT_5_5_5_1;if(i===p_)return t.UNSIGNED_INT_5_9_9_9_REV;if(i===d_)return t.BYTE;if(i===h_)return t.SHORT;if(i===Co)return t.UNSIGNED_SHORT;if(i===Md)return t.INT;if(i===Er)return t.UNSIGNED_INT;if(i===ai)return t.FLOAT;if(i===Io)return t.HALF_FLOAT;if(i===m_)return t.ALPHA;if(i===g_)return t.RGB;if(i===Nn)return t.RGBA;if(i===__)return t.LUMINANCE;if(i===v_)return t.LUMINANCE_ALPHA;if(i===gs)return t.DEPTH_COMPONENT;if(i===Rs)return t.DEPTH_STENCIL;if(i===x_)return t.RED;if(i===wd)return t.RED_INTEGER;if(i===y_)return t.RG;if(i===Ad)return t.RG_INTEGER;if(i===Cd)return t.RGBA_INTEGER;if(i===Ba||i===Ha||i===Va||i===Ga)if(o===nt)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===Ba)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Ha)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Va)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Ga)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===Ba)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Ha)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Va)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Ga)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===$c||i===Zc||i===Qc||i===Jc)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===$c)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Zc)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Qc)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Jc)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===ef||i===tf||i===nf)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===ef||i===tf)return o===nt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===nf)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===rf||i===sf||i===of||i===af||i===lf||i===uf||i===cf||i===ff||i===df||i===hf||i===pf||i===mf||i===gf||i===_f)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===rf)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===sf)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===of)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===af)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===lf)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===uf)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===cf)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===ff)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===df)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===hf)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===pf)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===mf)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===gf)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===_f)return o===nt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Wa||i===vf||i===xf)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===Wa)return o===nt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===vf)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===xf)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===S_||i===yf||i===Sf||i===Mf)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===Wa)return s.COMPRESSED_RED_RGTC1_EXT;if(i===yf)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Sf)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Mf)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Cs?t.UNSIGNED_INT_24_8:t[i]!==void 0?t[i]:null}return{convert:n}}class _w extends xn{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Ta extends Ft{constructor(){super(),this.isGroup=!0,this.type="Group"}}const vw={type:"move"};class Xu{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Ta,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Ta,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new k,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new k),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Ta,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new k,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new k),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const n=this._hand;if(n)for(const i of e.hand.values())this._getHandJoint(n,i)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,n,i){let r=null,s=null,o=null;const a=this._targetRay,l=this._grip,u=this._hand;if(e&&n.session.visibilityState!=="visible-blurred"){if(u&&e.hand){o=!0;for(const S of e.hand.values()){const p=n.getJointPose(S,i),c=this._getHandJoint(u,S);p!==null&&(c.matrix.fromArray(p.transform.matrix),c.matrix.decompose(c.position,c.rotation,c.scale),c.matrixWorldNeedsUpdate=!0,c.jointRadius=p.radius),c.visible=p!==null}const f=u.joints["index-finger-tip"],h=u.joints["thumb-tip"],d=f.position.distanceTo(h.position),m=.02,x=.005;u.inputState.pinching&&d>m+x?(u.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!u.inputState.pinching&&d<=m-x&&(u.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=n.getPose(e.gripSpace,i),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(r=n.getPose(e.targetRaySpace,i),r===null&&s!==null&&(r=s),r!==null&&(a.matrix.fromArray(r.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,r.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(r.linearVelocity)):a.hasLinearVelocity=!1,r.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(r.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(vw)))}return a!==null&&(a.visible=r!==null),l!==null&&(l.visible=s!==null),u!==null&&(u.visible=o!==null),this}_getHandJoint(e,n){if(e.joints[n.jointName]===void 0){const i=new Ta;i.matrixAutoUpdate=!1,i.visible=!1,e.joints[n.jointName]=i,e.add(i)}return e.joints[n.jointName]}}const xw=`
void main() {
...
}`;class Sw{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,n,i){if(this.texture===null){const r=new rn,s=e.properties.get(r);s.__webglTexture=n.texture,(n.depthNear!=i.depthNear||n.depthFar!=i.depthFar)&&(this.depthNear=n.depthNear,this.depthFar=n.depthFar),this.texture=r}}getMesh(e){if(this.texture!==null&&this.mesh===null){const n=e.cameras[0].viewport,i=new Yi({vertexShader:xw,fragmentShader:yw,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new jn(new Vl(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class Mw extends Rr{constructor(e,n){super();const i=this;let r=null,s=1,o=null,a="local-floor",l=1,u=null,f=null,h=null,d=null,m=null,x=null;const S=new Sw,p=n.getContextAttributes();let c=null,g=null;const _=[],T=[],D=new Ue;let C=null;const A=new xn;A.layers.enable(1),A.viewport=new wt;const I=new xn;I.layers.enable(2),I.viewport=new wt;const M=[A,I],v=new _w;v.layers.enable(1),v.layers.enable(2);let R=null,X=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(V){let ee=_[V];return ee===void 0&&(ee=new Xu,_[V]=ee),ee.getTargetRaySpace()},this.getControllerGrip=function(V){let ee=_[V];return ee===void 0&&(ee=new Xu,_[V]=ee),ee.getGripSpace()},this.getHand=function(V){let ee=_[V];return ee===void 0&&(ee=new Xu,_[V]=ee),ee.getHandSpace()};function U(V){const ee=T.indexOf(V.inputSource);if(ee===-1)return;const ce=_[ee];ce!==void 0&&(ce.update(V.inputSource,V.frame,u||o),ce.dispatchEvent({type:V.type,data:V.inputSource}))}function K(){r.removeEventListener("select",U),r.removeEventListener("selectstart",U),r.removeEventListener("selectend",U),r.removeEventListener("squeeze",U),r.removeEventListener("squeezestart",U),r.removeEventListener("squeezeend",U),r.removeEventListener("end",K),r.removeEventListener("inputsourceschange",j);for(let V=0;V<_.length;V++){const ee=T[V];ee!==null&&(T[V]=null,_[V].disconnect(ee))}R=null,X=null,S.reset(),e.setRenderTarget(c),m=null,d=null,h=null,r=null,g=null,Ee.stop(),i.isPresenting=!1,e.setPixelRatio(C),e.setSize(D.width,D.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(V){s=V,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(V){a=V,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return u||o},this.setReferenceSpace=function(V){u=V},this.getBaseLayer=function(){return d!==null?d:m},this.getBinding=function(){return h},this.getFrame=function(){return x},this.getSession=function(){return r},this.setSession=async function(V){if(r=V,r!==null){if(c=e.getRenderTarget(),r.addEventListener("select",U),r.addEventListener("selectstart",U),r.addEventListener("selectend",U),r.addEventListener("squeeze",U),r.addEventListener("squeezestart",U),r.addEventListener("squeezeend",U),r.addEventListener("end",K),r.addEventListener("inputsourceschange",j),p.xrCompatible!==!0&&await n.makeXRCompatible(),C=e.getPixelRatio(),e.getSize(D),r.renderState.layers===void 0){const ee={antialias:p.antialias,alpha:!0,depth:p.depth,stencil:p.stencil,framebufferScaleFactor:s};m=new XRWebGLLayer(r,n,ee),r.updateRenderState({baseLayer:m}),e.setPixelRatio(1),e.setSize(m.framebufferWidth,m.framebufferHeight,!1),g=new Tr(m.framebufferWidth,m.framebufferHeight,{format:Nn,type:pi,colorSpace:e.outputColorSpace,stencilBuffer:p.stencil})}else{let ee=null,ce=null,ue=null;p.depth&&(ue=p.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,ee=p.stencil?Rs:gs,ce=p.stencil?Cs:Er);const be={colorFormat:n.RGBA8,depthFormat:ue,scaleFactor:s};h=new XRWebGLBinding(r,n),d=h.createProjectionLayer(be),r.updateRenderState({layers:[d]}),e.setPixelRatio(1),e.setSize(d.textureWidth,d.textureHeight,!1),g=new Tr(d.textureWidth,d.textureHeight,{format:Nn,type:pi,depthTexture:new k_(d.textureWidth,d.textureHeight,ce,void 0,void 0,void 0,void 0,void 0,void 0,ee),stencilBuffer:p.stencil,colorSpace:e.outputColorSpace,samples:p.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1})}g.isXRRenderTarget=!0,this.setFoveation(l),u=null,o=await r.requestReferenceSpace(a),Ee.setContext(r),Ee.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return S.getDepthTexture()};function j(V){for(let ee=0;ee<V.removed.length;ee++){const ce=V.removed[ee],ue=T.indexOf(ce);ue>=0&&(T[ue]=null,_[ue].disconnect(ce))}for(let ee=0;ee<V.added.length;ee++){const ce=V.added[ee];let ue=T.indexOf(ce);if(ue===-1){for(let Fe=0;Fe<_.length;Fe++)if(Fe>=T.length){T.push(ce),ue=Fe;break}else if(T[Fe]===null){T[Fe]=ce,ue=Fe;break}if(ue===-1)break}const be=_[ue];be&&be.connect(ce)}}const O=new k,$=new k;function b(V,ee,ce){O.setFromMatrixPosition(ee.matrixWorld),$.setFromMatrixPosition(ce.matrixWorld);const ue=O.distanceTo($),be=ee.projectionMatrix.elements,Fe=ce.projectionMatrix.elements,ze=be[14]/(be[10]-1),Je=be[14]/(be[10]+1),L=(be[9]+1)/be[5],ut=(be[9]-1)/be[5],Xe=(be[8]-1)/be[0],je=(Fe[8]+1)/Fe[0],xe=ze*Xe,ct=ze*je,Le=ue/(-Xe+je),Ie=Le*-Xe;ee.matrixWorld.decompose(V.position,V.quaternion,V.scale),V.translateX(Ie),V.translateZ(Le),V.matrixWorld.compose(V.position,V.quaternion,V.scale),V.matrixWorldInverse.copy(V.matrixWorld).invert();const P=ze+Le,E=Je+Le,W=xe-Ie,te=ct+(ue-Ie),ie=L*Je/E*P,J=ut*Je/E*P;V.projectionMatrix.makePerspective(W,te,ie,J,P,E),V.projectionMatrixInverse.copy(V.projectionMatrix).invert()}function Y(V,ee){ee===null?V.matrixWorld.copy(V.matrix):V.matrixWorld.multiplyMatrices(ee.matrixWorld,V.matrix),V.matrixWorldInverse.copy(V.matrixWorld).invert()}this.updateCamera=function(V){if(r===null)return;S.texture!==null&&(V.near=S.depthNear,V.far=S.depthFar),v.near=I.near=A.near=V.near,v.far=I.far=A.far=V.far,(R!==v.near||X!==v.far)&&(r.updateRenderState({depthNear:v.near,depthFar:v.far}),R=v.near,X=v.far,A.near=R,A.far=X,I.near=R,I.far=X,A.updateProjectionMatrix(),I.updateProjectionMatrix(),V.updateProjectionMatrix());const ee=V.parent,ce=v.cameras;Y(v,ee);for(let ue=0;ue<ce.length;ue++)Y(ce[ue],ee);ce.length===2?b(v,A,I):v.projectionMatrix.copy(A.projectionMatrix),Z(V,v,ee)};function Z(V,ee,ce){ce===null?V.matrix.copy(ee.matrixWorld):(V.matrix.copy(ce.matrixWorld),V.matrix.invert(),V.matrix.multiply(ee.matrixWorld)),V.matrix.decompose(V.position,V.quaternion,V.scale),V.updateMatrixWorld(!0),V.projectionMatrix.copy(ee.projectionMatrix),V.projectionMatrixInverse.copy(ee.projectionMatrixInverse),V.isPerspectiveCamera&&(V.fov=Ef*2*Math.atan(1/V.projectionMatrix.elements[5]),V.zoom=1)}this.getCamera=function(){return v},this.getFoveation=function(){if(!(d===null&&m===null))return l},this.setFoveation=function(V){l=V,d!==null&&(d.fixedFoveation=V),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=V)},this.hasDepthSensing=function(){return S.texture!==null},this.getDepthSensingMesh=function(){return S.getMesh(v)};let Q=null;function ge(V,ee){if(f=ee.getViewerPose(u||o),x=ee,f!==null){const ce=f.views;m!==null&&(e.setRenderTargetFramebuffer(g,m.framebuffer),e.setRenderTarget(g));let ue=!1;ce.length!==v.cameras.length&&(v.cameras.length=0,ue=!0);for(let Fe=0;Fe<ce.length;Fe++){const ze=ce[Fe];let Je=null;if(m!==null)Je=m.getViewport(ze);else{const ut=h.getViewSubImage(d,ze);Je=ut.viewport,Fe===0&&(e.setRenderTargetTextures(g,ut.colorTexture,d.ignoreDepthValues?void 0:ut.depthStencilTexture),e.setRenderTarget(g))}let L=M[Fe];L===void 0&&(L=new xn,L.layers.enable(Fe),L.viewport=new wt,M[Fe]=L),L.matrix.fromArray(ze.transform.matrix),L.matrix.decompose(L.position,L.quaternion,L.scale),L.projectionMatrix.fromArray(ze.projectionMatrix),L.projectionMatrixInverse.copy(L.projectionMatrix).invert(),L.viewport.set(Je.x,Je.y,Je.width,Je.height),Fe===0&&(v.matrix.copy(L.matrix),v.matrix.decompose(v.position,v.quaternion,v.scale)),ue===!0&&v.cameras.push(L)}const be=r.enabledFeatures;if(be&&be.includes("depth-sensing")){const Fe=h.getDepthInformation(ce[0]);Fe&&Fe.isValid&&Fe.texture&&S.init(e,Fe,r.renderState)}}for(let ce=0;ce<_.length;ce++){const ue=T[ce],be=_[ce];ue!==null&&be!==void 0&&be.update(ue,ee,u||o)}Q&&Q(V,ee),ee.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:ee}),x=null}const Ee=new F_;Ee.setAnimationLoop(ge),this.setAnimationLoop=function(V){Q=V},this.dispose=function(){}}}const rr=new Kn,Ew=new pt;function Tw(t,e){function n(p,c){p.matrixAutoUpdate===!0&&p.updateMatrix(),c.value.copy(p.matrix)}function i(p,c){c.color.getRGB(p.fogColor.value,I_(t)),c.isFog?(p.fogNear.value=c.near,p.fogFar.value=c.far):c.isFogExp2&&(p.fogDensity.value=c.density)}function r(p,c,g,_,T){c.isMeshBasicMaterial||c.isMeshLambertMaterial?s(p,c):c.isMeshToonMaterial?(s(p,c),h(p,c)):c.isMeshPhongMaterial?(s(p,c),f(p,c)):c.isMeshStandardMaterial?(s(p,c),d(p,c),c.isMeshPhysicalMaterial&&m(p,c,T)):c.isMeshMatcapMaterial?(s(p,c),x(p,c)):c.isMeshDepthMaterial?s(p,c):c.isMeshDistanceMaterial?(s(p,c),S(p,c)):c.isMeshNormalMaterial?s(p,c):c.isLineBasicMaterial?(o(p,c),c.isLineDashedMaterial&&a(p,c)):c.isPointsMaterial?l(p,c,g,_):c.isSpriteMaterial?u(p,c):c.isShadowMaterial?(p.color.value.copy(c.color),p.opacity.value=c.opacity):c.isShaderMaterial&&(c.uniformsNeedUpdate=!1)}function s(p,c){p.opacity.value=c.opacity,c.color&&p.diffuse.value.copy(c.color),c.emissive&&p.emissive.value.copy(c.emissive).multiplyScalar(c.emissiveIntensity),c.map&&(p.map.value=c.map,n(c.map,p.mapTransform)),c.alphaMap&&(p.alphaMap.value=c.alphaMap,n(c.alphaMap,p.alphaMapTransform)),c.bumpMap&&(p.bumpMap.value=c.bumpMap,n(c.bumpMap,p.bumpMapTransform),p.bumpScale.value=c.bumpScale,c.side===nn&&(p.bumpScale.value*=-1)),c.normalMap&&(p.normalMap.value=c.normalMap,n(c.normalMap,p.normalMapTransform),p.normalScale.value.copy(c.normalScale),c.side===nn&&p.normalScale.value.negate()),c.displacementMap&&(p.displacementMap.value=c.displacementMap,n(c.displacementMap,p.displacementMapTransform),p.displacementScale.value=c.displacementScale,p.displacementBias.value=c.displacementBias),c.emissiveMap&&(p.emissiveMap.value=c.emissiveMap,n(c.emissiveMap,p.emissiveMapTransform)),c.specularMap&&(p.specularMap.value=c.specularMap,n(c.specularMap,p.specularMapTransform)),c.alphaTest>0&&(p.alphaTest.value=c.alphaTest);const g=e.get(c),_=g.envMap,T=g.envMapRotation;_&&(p.envMap.value=_,rr.copy(T),rr.x*=-1,rr.y*=-1,rr.z*=-1,_.isCubeTexture&&_.isRenderTargetTexture===!1&&(rr.y*=-1,rr.z*=-1),p.envMapRotation.value.setFromMatrix4(Ew.makeRotationFromEuler(rr)),p.flipEnvMap.value=_.isCubeTexture&&_.isRenderTargetTexture===!1?-1:1,p.reflectivity.value=c.reflectivity,p.ior.value=c.ior,p.refractionRatio.value=c.refractionRatio),c.lightMap&&(p.lightMap.value=c.lightMap,p.lightMapIntensity.value=c.lightMapIntensity,n(c.lightMap,p.lightMapTransform)),c.aoMap&&(p.aoMap.value=c.aoMap,p.aoMapIntensity.value=c.aoMapIntensity,n(c.aoMap,p.aoMapTransform))}function o(p,c){p.diffuse.value.copy(c.color),p.opacity.value=c.opacity,c.map&&(p.map.value=c.map,n(c.map,p.mapTransform))}function a(p,c){p.dashSize.value=c.dashSize,p.totalSize.value=c.dashSize+c.gapSize,p.scale.value=c.scale}function l(p,c,g,_){p.diffuse.value.copy(c.color),p.opacity.value=c.opacity,p.size.value=c.size*g,p.scale.value=_*.5,c.map&&(p.map.value=c.map,n(c.map,p.uvTransform)),c.alphaMap&&(p.alphaMap.value=c.alphaMap,n(c.alphaMap,p.alphaMapTransform)),c.alphaTest>0&&(p.alphaTest.value=c.alphaTest)}function u(p,c){p.diffuse.value.copy(c.color),p.opacity.value=c.opacity,p.rotation.value=c.rotation,c.map&&(p.map.value=c.map,n(c.map,p.mapTransform)),c.alphaMap&&(p.alphaMap.value=c.alphaMap,n(c.alphaMap,p.alphaMapTransform)),c.alphaTest>0&&(p.alphaTest.value=c.alphaTest)}function f(p,c){p.specular.value.copy(c.specular),p.shininess.value=Math.max(c.shininess,1e-4)}function h(p,c){c.gradientMap&&(p.gradientMap.value=c.gradientMap)}function d(p,c){p.metalness.value=c.metalness,c.metalnessMap&&(p.metalnessMap.value=c.metalnessMap,n(c.metalnessMap,p.metalnessMapTransform)),p.roughness.value=c.roughness,c.roughnessMap&&(p.roughnessMap.value=c.roughnessMap,n(c.roughnessMap,p.roughnessMapTransform)),c.envMap&&(p.envMapIntensity.value=c.envMapIntensity)}function m(p,c,g){p.ior.value=c.ior,c.sheen>0&&(p.sheenColor.value.copy(c.sheenColor).multiplyScalar(c.sheen),p.sheenRoughness.value=c.sheenRoughness,c.sheenColorMap&&(p.sheenColorMap.value=c.sheenColorMap,n(c.sheenColorMap,p.sheenColorMapTransform)),c.sheenRoughnessMap&&(p.sheenRoughnessMap.value=c.sheenRoughnessMap,n(c.sheenRoughnessMap,p.sheenRoughnessMapTransform))),c.clearcoat>0&&(p.clearcoat.value=c.clearcoat,p.clearcoatRoughness.value=c.clearcoatRoughness,c.clearcoatMap&&(p.clearcoatMap.value=c.clearcoatMap,n(c.clearcoatMap,p.clearcoatMapTransform)),c.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=c.clearcoatRoughnessMap,n(c.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),c.clearcoatNormalMap&&(p.clearcoatNormalMap.value=c.clearcoatNormalMap,n(c.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(c.clearcoatNormalScale),c.side===nn&&p.clearcoatNormalScale.value.negate())),c.dispersion>0&&(p.dispersion.value=c.dispersion),c.iridescence>0&&(p.iridescence.value=c.iridescence,p.iridescenceIOR.value=c.iridescenceIOR,p.iridescenceThicknessMinimum.value=c.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=c.iridescenceThicknessRange[1],c.iridescenceMap&&(p.iridescenceMap.value=c.iridescenceMap,n(c.iridescenceMap,p.iridescenceMapTransform)),c.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=c.iridescenceThicknessMap,n(c.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),c.transmission>0&&(p.transmission.value=c.transmission,p.transmissionSamplerMap.value=g.texture,p.transmissionSamplerSize.value.set(g.width,g.height),c.transmissionMap&&(p.transmissionMap.value=c.transmissionMap,n(c.transmissionMap,p.transmissionMapTransform)),p.thickness.value=c.thickness,c.thicknessMap&&(p.thicknessMap.value=c.thicknessMap,n(c.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=c.attenuationDistance,p.attenuationColor.value.copy(c.attenuationColor)),c.anisotropy>0&&(p.anisotropyVector.value.set(c.anisotropy*Math.cos(c.anisotropyRotation),c.anisotropy*Math.sin(c.anisotropyRotation)),c.anisotropyMap&&(p.anisotropyMap.value=c.anisotropyMap,n(c.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=c.specularIntensity,p.specularColor.value.copy(c.specularColor),c.specularColorMap&&(p.specularColorMap.value=c.specularColorMap,n(c.specularColorMap,p.specularColorMapTransform)),c.specularIntensityMap&&(p.specularIntensityMap.value=c.specularIntensityMap,n(c.specularIntensityMap,p.specularIntensityMapTransform))}function x(p,c){c.matcap&&(p.matcap.value=c.matcap)}function S(p,c){const g=e.get(c).light;p.referencePosition.value.setFromMatrixPosition(g.matrixWorld),p.nearDistance.value=g.shadow.camera.near,p.farDistance.value=g.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function ww(t,e,n,i){let r={},s={},o=[];const a=t.getParameter(t.MAX_UNIFORM_BUFFER_BINDINGS);function l(g,_){const T=_.program;i.uniformBlockBinding(g,T)}function u(g,_){let T=r[g.id];T===void 0&&(x(g),T=f(g),r[g.id]=T,g.addEventListener("dispose",p));const D=_.program;i.updateUBOMapping(g,D);const C=e.render.frame;s[g.id]!==C&&(d(g),s[g.id]=C)}function f(g){const _=h();g.__bindingPointIndex=_;const T=t.createBuffer(),D=g.__size,C=g.usage;return t.bindBuffer(t.UNIFORM_BUFFER,T),t.bufferData(t.UNIFORM_BUFFER,D,C),t.bindBuffer(t.UNIFORM_BUFFER,null),t.bindBufferBase(t.UNIFORM_BUFFER,_,T),T}function h(){for(let g=0;g<a;g++)if(o.indexOf(g)===-1)return o.push(g),g;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(g){const _=r[g.id],T=g.uniforms,D=g.__cache;t.bindBuffer(t.UNIFORM_BUFFER,_);for(let C=0,A=T.length;C<A;C++){const I=Array.isArray(T[C])?T[C]:[T[C]];for(let M=0,v=I.length;M<v;M++){const R=I[M];if(m(R,C,M,D)===!0){const X=R.__offset,U=Array.isArray(R.value)?R.value:[R.value];let K=0;for(let j=0;j<U.length;j++){const O=U[j],$=S(O);typeof O=="number"||typeof O=="boolean"?(R.__data[0]=O,t.bufferSubData(t.UNIFORM_BUFFER,X+K,R.__data)):O.isMatrix3?(R.__data[0]=O.elements[0],R.__data[1]=O.elements[1],R.__data[2]=O.elements[2],R.__data[3]=0,R.__data[4]=O.elements[3],R.__data[5]=O.elements[4],R.__data[6]=O.elements[5],R.__data[7]=0,R.__data[8]=O.elements[6],R.__data[9]=O.elements[7],R.__data[10]=O.elements[8],R.__data[11]=0):(O.toArray(R.__data,K),K+=$.storage/Float32Array.BYTES_PER_ELEMENT)}t.bufferSubData(t.UNIFORM_BUFFER,X,R.__data)}}}t.bindBuffer(t.UNIFORM_BUFFER,null)}function m(g,_,T,D){const C=g.value,A=_+"_"+T;if(D[A]===void 0)return typeof C=="number"||typeof C=="boolean"?D[A]=C:D[A]=C.clone(),!0;{const I=D[A];if(typeof C=="number"||typeof C=="boolean"){if(I!==C)return D[A]=C,!0}else if(I.equals(C)===!1)return I.copy(C),!0}return!1}function x(g){const _=g.uniforms;let T=0;const D=16;for(let A=0,I=_.length;A<I;A++){const M=Array.isArray(_[A])?_[A]:[_[A]];for(let v=0,R=M.length;v<R;v++){const X=M[v],U=Array.isArray(X.value)?X.value:[X.value];for(let K=0,j=U.length;K<j;K++){const O=U[K],$=S(O),b=T%D;b!==0&&D-b<$.boundary&&(T+=D-b),X.__data=new Float32Array($.storage/Float32Array.BYTES_PER_ELEMENT),X.__offset=T,T+=$.storage}}}const C=T%D;return C>0&&(T+=D-C),g.__size=T,g.__cache={},this}function S(g){const _={boundary:0,storage:0};return typeof g=="number"||typeof g=="boolean"?(_.boundary=4,_.storage=4):g.isVector2?(_.boundary=8,_.storage=8):g.isVector3||g.isColor?(_.boundary=16,_.storage=12):g.isVector4?(_.boundary=16,_.storage=16):g.isMatrix3?(_.boundary=48,_.storage=48):g.isMatrix4?(_.boundary=64,_.storage=64):g.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",g),_}function p(g){const _=g.target;_.removeEventListener("dispose",p);const T=o.indexOf(_.__bindingPointIndex);o.splice(T,1),t.deleteBuffer(r[_.id]),delete r[_.id],delete s[_.id]}function c(){for(const g in r)t.deleteBuffer(r[g]);o=[],r={},s={}}return{bind:l,update:u,dispose:c}}class Aw{constructor(e={}){const{canvas:n=_y(),context:i=null,depth:r=!0,stencil:s=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:u=!1,powerPreference:f="default",failIfMajorPerformanceCaveat:h=!1}=e;this.isWebGLRenderer=!0;let d;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");d=i.getContextAttributes().alpha}else d=o;const m=new Uint32Array(4),x=new Int32Array(4);let S=null,p=null;const c=[],g=[];this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=Hn,this.toneMapping=Gi,this.toneMappingExposure=1;const _=this;let T=!1,D=0,C=0,A=null,I=-1,M=null;const v=new wt,R=new wt;let X=null;const U=new Ve(0);let K=0,j=n.width,O=n.height,$=1,b=null,Y=null;const Z=new wt(0,0,j,O),Q=new wt(0,0,j,O);let ge=!1;const Ee=new bd;let V=!1,ee=!1;const ce=new pt,ue=new k,be=new wt,Fe={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let ze=!1;function Je(){return A===null?$:1}let L=i;function ut(w,N){return n.getContext(w,N)}try{const w={alpha:!0,depth:r,stencil:s,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:u,powerPreference:f,failIfMajorPerformanceCaveat:h};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${yd}`),n.addEventListener("webglcontextlost",B,!1),n.addEventListener("webglcontextrestored",q,!1),n.addEventListener("webglcontextcreationerror",ne,!1),L===null){const N="webgl2";if(L=ut(N,w),L===null)throw ut(N)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(w){throw console.error("THREE.WebGLRenderer: "+w.message),w}let Xe,je,xe,ct,Le,Ie,P,E,W,te,ie,J,Me,ae,de,Ne,se,he,He,we,me,Ce,De,rt;function y(){Xe=new IE(L),Xe.init(),Ce=new gw(L,Xe),je=new CE(L,Xe,e,Ce),xe=new hw(L),ct=new FE(L),Le=new JT,Ie=new mw(L,Xe,xe,Le,je,Ce,ct),P=new PE(_),E=new DE(_),W=new Gy(L),De=new wE(L,W),te=new UE(L,W,ct,De),ie=new kE(L,te,W,ct),He=new OE(L,je,Ie),Ne=new RE(Le),J=new QT(_,P,E,Xe,je,De,Ne),Me=new Tw(_,Le),ae=new tw,de=new aw(Xe),he=new TE(_,P,E,xe,ie,d,l),se=new dw(_,ie,je),rt=new ww(L,ct,je,xe),we=new AE(L,Xe,ct),me=new NE(L,Xe,ct),ct.programs=J.programs,_.capabilities=je,_.extensions=Xe,_.properties=Le,_.renderLists=ae,_.shadowMap=se,_.state=xe,_.info=ct}y();const z=new Mw(_,L);this.xr=z,this.getContext=function(){return L},this.getContextAttributes=function(){return L.getContextAttributes()},this.forceContextLoss=function(){const w=Xe.get("WEBGL_lose_context");w&&w.loseContext()},this.forceContextRestore=function(){const w=Xe.get("WEBGL_lose_context");w&&w.restoreContext()},this.getPixelRatio=function(){return $},this.setPixelRatio=function(w){w!==void 0&&($=w,this.setSize(j,O,!1))},this.getSize=function(w){return w.set(j,O)},this.setSize=function(w,N,H=!0){if(z.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}j=w,O=N,n.width=Math.floor(w*$),n.height=Math.floor(N*$),H===!0&&(n.style.width=w+"px",n.style.height=N+"px"),this.setViewport(0,0,w,N)},this.getDrawingBufferSize=function(w){return w.set(j*$,O*$).floor()},this.setDrawingBufferSize=function(w,N,H){j=w,O=N,$=H,n.width=Math.floor(w*H),n.height=Math.floor(N*H),this.setViewport(0,0,w,N)},this.getCurrentViewport=function(w){return w.copy(v)},this.getViewport=function(w){return w.copy(Z)},this.setViewport=function(w,N,H,G){w.isVector4?Z.set(w.x,w.y,w.z,w.w):Z.set(w,N,H,G),xe.viewport(v.copy(Z).multiplyScalar($).round())},this.getScissor=function(w){return w.copy(Q)},this.setScissor=function(w,N,H,G){w.isVector4?Q.set(w.x,w.y,w.z,w.w):Q.set(w,N,H,G),xe.scissor(R.copy(Q).multiplyScalar($).round())},this.getScissorTest=function(){return ge},this.setScissorTest=function(w){xe.setScissorTest(ge=w)},this.setOpaqueSort=function(w){b=w},this.setTransparentSort=function(w){Y=w},this.getClearColor=function(w){return w.copy(he.getClearColor())},this.setClearColor=function(){he.setClearColor.apply(he,arguments)},this.getClearAlpha=function(){return he.getClearAlpha()},this.setClearAlpha=function(){he.setClearAlpha.apply(he,arguments)},this.clear=function(w=!0,N=!0,H=!0){let G=0;if(w){let F=!1;if(A!==null){const oe=A.texture.format;F=oe===Cd||oe===Ad||oe===wd}if(F){const oe=A.texture.type,fe=oe===pi||oe===Er||oe===Co||oe===Cs||oe===Ed||oe===Td,_e=he.getClearColor(),ve=he.getClearAlpha(),Ae=_e.r,Pe=_e.g,Te=_e.b;fe?(m[0]=Ae,m[1]=Pe,m[2]=Te,m[3]=ve,L.clearBufferuiv(L.COLOR,0,m)):(x[0]=Ae,x[1]=Pe,x[2]=Te,x[3]=ve,L.clearBufferiv(L.COLOR,0,x))}else G|=L.COLOR_BUFFER_BIT}N&&(G|=L.DEPTH_BUFFER_BIT),H&&(G|=L.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),L.clear(G)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){n.removeEventListener("webglcontextlost",B,!1),n.removeEventListener("webglcontextrestored",q,!1),n.removeEventListener("webglcontextcreationerror",ne,!1),ae.dispose(),de.dispose(),Le.dispose(),P.dispose(),E.dispose(),ie.dispose(),De.dispose(),rt.dispose(),J.dispose(),z.dispose(),z.removeEventListener("sessionstart",_t),z.removeEventListener("sessionend",_i),Dt.stop()};function B(w){w.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),T=!0}function q(){console.log("THREE.WebGLRenderer: Context Restored."),T=!1;const w=ct.autoReset,N=se.enabled,H=se.autoUpdate,G=se.needsUpdate,F=se.type;y(),ct.autoReset=w,se.enabled=N,se.autoUpdate=H,se.needsUpdate=G,se.type=F}function ne(w){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",w.statusMessage)}function ye(w){const N=w.target;N.removeEventListener("dispose",ye),Re(N)}function Re(w){mt(w),Le.remove(w)}function mt(w){const N=Le.get(w).programs;N!==void 0&&(N.forEach(function(H){J.releaseProgram(H)}),w.isShaderMaterial&&J.releaseShaderCache(w))}this.renderBufferDirect=function(w,N,H,G,F,oe){N===null&&(N=Fe);const fe=F.isMesh&&F.matrixWorld.determinant()<0,_e=X_(w,N,H,G,F);xe.setMaterial(G,fe);let ve=H.index,Ae=1;if(G.wireframe===!0){if(ve=te.getWireframeAttribute(H),ve===void 0)return;Ae=2}const Pe=H.drawRange,Te=H.attributes.position;let Ye=Pe.start*Ae,ft=(Pe.start+Pe.count)*Ae;oe!==null&&(Ye=Math.max(Ye,oe.start*Ae),ft=Math.min(ft,(oe.start+oe.count)*Ae)),ve!==null?(Ye=Math.max(Ye,0),ft=Math.min(ft,ve.count)):Te!=null&&(Ye=Math.max(Ye,0),ft=Math.min(ft,Te.count));const dt=ft-Ye;if(dt<0||dt===1/0)return;De.setup(F,G,_e,H,ve);let sn,qe=we;if(ve!==null&&(sn=W.get(ve),qe=me,qe.setIndex(sn)),F.isMesh)G.wireframe===!0?(xe.setLineWidth(G.wireframeLinewidth*Je()),qe.setMode(L.LINES)):qe.setMode(L.TRIANGLES);else if(F.isLine){let Se=G.linewidth;Se===void 0&&(Se=1),xe.setLineWidth(Se*Je()),F.isLineSegments?qe.setMode(L.LINES):F.isLineLoop?qe.setMode(L.LINE_LOOP):qe.setMode(L.LINE_STRIP)}else F.isPoints?qe.setMode(L.POINTS):F.isSprite&&qe.setMode(L.TRIANGLES);if(F.isBatchedMesh)if(F._multiDrawInstances!==null)qe.renderMultiDrawInstances(F._multiDrawStarts,F._multiDrawCounts,F._multiDrawCount,F._multiDrawInstances);else if(Xe.get("WEBGL_multi_draw"))qe.renderMultiDraw(F._multiDrawStarts,F._multiDrawCounts,F._multiDrawCount);else{const Se=F._multiDrawStarts,It=F._multiDrawCounts,Ke=F._multiDrawCount,An=ve?W.get(ve).bytesPerElement:1,Pr=Le.get(G).currentProgram.getUniforms();for(let on=0;on<Ke;on++)Pr.setValue(L,"_gl_DrawID",on),qe.render(Se[on]/An,It[on])}else if(F.isInstancedMesh)qe.renderInstances(Ye,dt,F.count);else if(H.isInstancedBufferGeometry){const Se=H._maxInstanceCount!==void 0?H._maxInstanceCount:1/0,It=Math.min(H.instanceCount,Se);qe.renderInstances(Ye,dt,It)}else qe.render(Ye,dt)};function St(w,N,H){w.transparent===!0&&w.side===Wn&&w.forceSinglePass===!1?(w.side=nn,w.needsUpdate=!0,ko(w,N,H),w.side=ji,w.needsUpdate=!0,ko(w,N,H),w.side=Wn):ko(w,N,H)}this.compile=function(w,N,H=null){H===null&&(H=w),p=de.get(H),p.init(N),g.push(p),H.traverseVisible(function(F){F.isLight&&F.layers.test(N.layers)&&(p.pushLight(F),F.castShadow&&p.pushShadow(F))}),w!==H&&w.traverseVisible(function(F){F.isLight&&F.layers.test(N.layers)&&(p.pushLight(F),F.castShadow&&p.pushShadow(F))}),p.setupLights();const G=new Set;return w.traverse(function(F){const oe=F.material;if(oe)if(Array.isArray(oe))for(let fe=0;fe<oe.length;fe++){const _e=oe[fe];St(_e,H,F),G.add(_e)}else St(oe,H,F),G.add(oe)}),g.pop(),p=null,G},this.compileAsync=function(w,N,H=null){const G=this.compile(w,N,H);return new Promise(F=>{function oe(){if(G.forEach(function(fe){Le.get(fe).currentProgram.isReady()&&G.delete(fe)}),G.size===0){F(w);return}setTimeout(oe,10)}Xe.get("KHR_parallel_shader_compile")!==null?oe():setTimeout(oe,10)})};let Ge=null;function Mt(w){Ge&&Ge(w)}function _t(){Dt.stop()}function _i(){Dt.start()}const Dt=new F_;Dt.setAnimationLoop(Mt),typeof self<"u"&&Dt.setContext(self),this.setAnimationLoop=function(w){Ge=w,z.setAnimationLoop(w),w===null?Dt.stop():Dt.start()},z.addEventListener("sessionstart",_t),z.addEventListener("sessionend",_i),this.render=function(w,N){if(N!==void 0&&N.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(T===!0)return;if(w.matrixWorldAutoUpdate===!0&&w.updateMatrixWorld(),N.parent===null&&N.matrixWorldAutoUpdate===!0&&N.updateMatrixWorld(),z.enabled===!0&&z.isPresenting===!0&&(z.cameraAutoUpdate===!0&&z.updateCamera(N),N=z.getCamera()),w.isScene===!0&&w.onBeforeRender(_,w,N,A),p=de.get(w,g.length),p.init(N),g.push(p),ce.multiplyMatrices(N.projectionMatrix,N.matrixWorldInverse),Ee.setFromProjectionMatrix(ce),ee=this.localClippingEnabled,V=Ne.init(this.clippingPlanes,ee),S=ae.get(w,c.length),S.init(),c.push(S),z.enabled===!0&&z.isPresenting===!0){const oe=_.xr.getDepthSensingMesh();oe!==null&&$n(oe,N,-1/0,_.sortObjects)}$n(w,N,0,_.sortObjects),S.finish(),_.sortObjects===!0&&S.sort(b,Y),ze=z.enabled===!1||z.isPresenting===!1||z.hasDepthSensing()===!1,ze&&he.addToRenderList(S,w),this.info.render.frame++,V===!0&&Ne.beginShadows();const H=p.state.shadowsArray;se.render(H,w,N),V===!0&&Ne.endShadows(),this.info.autoReset===!0&&this.info.reset();const G=S.opaque,F=S.transmissive;if(p.setupLights(),N.isArrayCamera){const oe=N.cameras;if(F.length>0)for(let fe=0,_e=oe.length;fe<_e;fe++){const ve=oe[fe];Ns(G,F,w,ve)}ze&&he.render(w);for(let fe=0,_e=oe.length;fe<_e;fe++){const ve=oe[fe];Qi(S,w,ve,ve.viewport)}}else F.length>0&&Ns(G,F,w,N),ze&&he.render(w),Qi(S,w,N);A!==null&&(Ie.updateMultisampleRenderTarget(A),Ie.updateRenderTargetMipmap(A)),w.isScene===!0&&w.onAfterRender(_,w,N),De.resetDefaultState(),I=-1,M=null,g.pop(),g.length>0?(p=g[g.length-1],V===!0&&Ne.setGlobalState(_.clippingPlanes,p.state.camera)):p=null,c.pop(),c.length>0?S=c[c.length-1]:S=null};function $n(w,N,H,G){if(w.visible===!1)return;if(w.layers.test(N.layers)){if(w.isGroup)H=w.renderOrder;else if(w.isLOD)w.autoUpdate===!0&&w.update(N);else if(w.isLight)p.pushLight(w),w.castShadow&&p.pushShadow(w);else if(w.isSprite){if(!w.frustumCulled||Ee.intersectsSprite(w)){G&&be.setFromMatrixPosition(w.matrixWorld).applyMatrix4(ce);const fe=ie.update(w),_e=w.material;_e.visible&&S.push(w,fe,_e,H,be.z,null)}}else if((w.isMesh||w.isLine||w.isPoints)&&(!w.frustumCulled||Ee.intersectsObject(w))){const fe=ie.update(w),_e=w.material;if(G&&(w.boundingSphere!==void 0?(w.boundingSphere===null&&w.computeBoundingSphere(),be.copy(w.boundingSphere.center)):(fe.boundingSphere===null&&fe.computeBoundingSphere(),be.copy(fe.boundingSphere.center)),be.applyMatrix4(w.matrixWorld).applyMatrix4(ce)),Array.isArray(_e)){const ve=fe.groups;for(let Ae=0,Pe=ve.length;Ae<Pe;Ae++){const Te=ve[Ae],Ye=_e[Te.materialIndex];Ye&&Ye.visible&&S.push(w,fe,Ye,H,be.z,Te)}}else _e.visible&&S.push(w,fe,_e,H,be.z,null)}}const oe=w.children;for(let fe=0,_e=oe.length;fe<_e;fe++)$n(oe[fe],N,H,G)}function Qi(w,N,H,G){const F=w.opaque,oe=w.transmissive,fe=w.transparent;p.setupLightsView(H),V===!0&&Ne.setGlobalState(_.clippingPlanes,H),G&&xe.viewport(v.copy(G)),F.length>0&&Oo(F,N,H),oe.length>0&&Oo(oe,N,H),fe.length>0&&Oo(fe,N,H),xe.buffers.depth.setTest(!0),xe.buffers.depth.setMask(!0),xe.buffers.color.setMask(!0),xe.setPolygonOffset(!1)}function Ns(w,N,H,G){if((H.isScene===!0?H.overrideMaterial:null)!==null)return;p.state.transmissionRenderTarget[G.id]===void 0&&(p.state.transmissionRenderTarget[G.id]=new Tr(1,1,{generateMipmaps:!0,type:Xe.has("EXT_color_buffer_half_float")||Xe.has("EXT_color_buffer_float")?Io:pi,minFilter:pr,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:$e.workingColorSpace}));const oe=p.state.transmissionRenderTarget[G.id],fe=G.viewport||v;oe.setSize(fe.z,fe.w);const _e=_.getRenderTarget();_.setRenderTarget(oe),_.getClearColor(U),K=_.getClearAlpha(),K<1&&_.setClearColor(16777215,.5),ze?he.render(H):_.clear();const ve=_.toneMapping;_.toneMapping=Gi;const Ae=G.viewport;if(G.viewport!==void 0&&(G.viewport=void 0),p.setupLightsView(G),V===!0&&Ne.setGlobalState(_.clippingPlanes,G),Oo(w,H,G),Ie.updateMultisampleRenderTarget(oe),Ie.updateRenderTargetMipmap(oe),Xe.has("WEBGL_multisampled_render_to_texture")===!1){let Pe=!1;for(let Te=0,Ye=N.length;Te<Ye;Te++){const ft=N[Te],dt=ft.object,sn=ft.geometry,qe=ft.material,Se=ft.group;if(qe.side===Wn&&dt.layers.test(G.layers)){const It=qe.side;qe.side=nn,qe.needsUpdate=!0,Dd(dt,H,G,sn,qe,Se),qe.side=It,qe.needsUpdate=!0,Pe=!0}}Pe===!0&&(Ie.updateMultisampleRenderTarget(oe),Ie.updateRenderTargetMipmap(oe))}_.setRenderTarget(_e),_.setClearColor(U,K),Ae!==void 0&&(G.viewport=Ae),_.toneMapping=ve}function Oo(w,N,H){const G=N.isScene===!0?N.overrideMaterial:null;for(let F=0,oe=w.length;F<oe;F++){const fe=w[F],_e=fe.object,ve=fe.geometry,Ae=G===null?fe.material:G,Pe=fe.group;_e.layers.test(H.layers)&&Dd(_e,N,H,ve,Ae,Pe)}}function Dd(w,N,H,G,F,oe){w.onBeforeRender(_,N,H,G,F,oe),w.modelViewMatrix.multiplyMatrices(H.matrixWorldInverse,w.matrixWorld),w.normalMatrix.getNormalMatrix(w.modelViewMatrix),F.transparent===!0&&F.side===Wn&&F.forceSinglePass===!1?(F.side=nn,F.needsUpdate=!0,_.renderBufferDirect(H,N,G,F,w,oe),F.side=ji,F.needsUpdate=!0,_.renderBufferDirect(H,N,G,F,w,oe),F.side=Wn):_.renderBufferDirect(H,N,G,F,w,oe),w.onAfterRender(_,N,H,G,F,oe)}function ko(w,N,H){N.isScene!==!0&&(N=Fe);const G=Le.get(w),F=p.state.lights,oe=p.state.shadowsArray,fe=F.state.version,_e=J.getParameters(w,F.state,oe,N,H),ve=J.getProgramCacheKey(_e);let Ae=G.programs;G.environment=w.isMeshStandardMaterial?N.environment:null,G.fog=N.fog,G.envMap=(w.isMeshStandardMaterial?E:P).get(w.envMap||G.environment),G.envMapRotation=G.environment!==null&&w.envMap===null?N.environmentRotation:w.envMapRotation,Ae===void 0&&(w.addEventListener("dispose",ye),Ae=new Map,G.programs=Ae);let Pe=Ae.get(ve);if(Pe!==void 0){if(G.currentProgram===Pe&&G.lightsStateVersion===fe)return Ud(w,_e),Pe}else _e.uniforms=J.getUniforms(w),w.onBeforeCompile(_e,_),Pe=J.acquireProgram(_e,ve),Ae.set(ve,Pe),G.uniforms=_e.uniforms;const Te=G.uniforms;return(!w.isShaderMaterial&&!w.isRawShaderMaterial||w.clipping===!0)&&(Te.clippingPlanes=Ne.uniform),Ud(w,_e),G.needsLights=Y_(w),G.lightsStateVersion=fe,G.needsLights&&(Te.ambientLightColor.value=F.state.ambient,Te.lightProbe.value=F.state.probe,Te.directionalLights.value=F.state.directional,Te.directionalLightShadows.value=F.state.directionalShadow,Te.spotLights.value=F.state.spot,Te.spotLightShadows.value=F.state.spotShadow,Te.rectAreaLights.value=F.state.rectArea,Te.ltc_1.value=F.state.rectAreaLTC1,Te.ltc_2.value=F.state.rectAreaLTC2,Te.pointLights.value=F.state.point,Te.pointLightShadows.value=F.state.pointShadow,Te.hemisphereLights.value=F.state.hemi,Te.directionalShadowMap.value=F.state.directionalShadowMap,Te.directionalShadowMatrix.value=F.state.directionalShadowMatrix,Te.spotShadowMap.value=F.state.spotShadowMap,Te.spotLightMatrix.value=F.state.spotLightMatrix,Te.spotLightMap.value=F.state.spotLightMap,Te.pointShadowMap.value=F.state.pointShadowMap,Te.pointShadowMatrix.value=F.state.pointShadowMatrix),G.currentProgram=Pe,G.uniformsList=null,Pe}function Id(w){if(w.uniformsList===null){const N=w.currentProgram.getUniforms();w.uniformsList=ja.seqWithValue(N.seq,w.uniforms)}return w.uniformsList}function Ud(w,N){const H=Le.get(w);H.outputColorSpace=N.outputColorSpace,H.batching=N.batching,H.batchingColor=N.batchingColor,H.instancing=N.instancing,H.instancingColor=N.instancingColor,H.instancingMorph=N.instancingMorph,H.skinning=N.skinning,H.morphTargets=N.morphTargets,H.morphNormals=N.morphNormals,H.morphColors=N.morphColors,H.morphTargetsCount=N.morphTargetsCount,H.numClippingPlanes=N.numClippingPlanes,H.numIntersection=N.numClipIntersection,H.vertexAlphas=N.vertexAlphas,H.vertexTangents=N.vertexTangents,H.toneMapping=N.toneMapping}function X_(w,N,H,G,F){N.isScene!==!0&&(N=Fe),Ie.resetTextureUnits();const oe=N.fog,fe=G.isMeshStandardMaterial?N.environment:null,_e=A===null?_.outputColorSpace:A.isXRRenderTarget===!0?A.texture.colorSpace:Zi,ve=(G.isMeshStandardMaterial?E:P).get(G.envMap||fe),Ae=G.vertexColors===!0&&!!H.attributes.color&&H.attributes.color.itemSize===4,Pe=!!H.attributes.tangent&&(!!G.normalMap||G.anisotropy>0),Te=!!H.morphAttributes.position,Ye=!!H.morphAttributes.normal,ft=!!H.morphAttributes.color;let dt=Gi;G.toneMapped&&(A===null||A.isXRRenderTarget===!0)&&(dt=_.toneMapping);const sn=H.morphAttributes.position||H.morphAttributes.normal||H.morphAttributes.color,qe=sn!==void 0?sn.length:0,Se=Le.get(G),It=p.state.lights;if(V===!0&&(ee===!0||w!==M)){const mn=w===M&&G.id===I;Ne.setState(G,w,mn)}let Ke=!1;G.version===Se.__version?(Se.needsLights&&Se.lightsStateVersion!==It.state.version||Se.outputColorSpace!==_e||F.isBatchedMesh&&Se.batching===!1||!F.isBatchedMesh&&Se.batching===!0||F.isBatchedMesh&&Se.batchingColor===!0&&F.colorTexture===null||F.isBatchedMesh&&Se.batchingColor===!1&&F.colorTexture!==null||F.isInstancedMesh&&Se.instancing===!1||!F.isInstancedMesh&&Se.instancing===!0||F.isSkinnedMesh&&Se.skinning===!1||!F.isSkinnedMesh&&Se.skinning===!0||F.isInstancedMesh&&Se.instancingColor===!0&&F.instanceColor===null||F.isInstancedMesh&&Se.instancingColor===!1&&F.instanceColor!==null||F.isInstancedMesh&&Se.instancingMorph===!0&&F.morphTexture===null||F.isInstancedMesh&&Se.instancingMorph===!1&&F.morphTexture!==null||Se.envMap!==ve||G.fog===!0&&Se.fog!==oe||Se.numClippingPlanes!==void 0&&(Se.numClippingPlanes!==Ne.numPlanes||Se.numIntersection!==Ne.numIntersection)||Se.vertexAlphas!==Ae||Se.vertexTangents!==Pe||Se.morphTargets!==Te||Se.morphNormals!==Ye||Se.morphColors!==ft||Se.toneMapping!==dt||Se.morphTargetsCount!==qe)&&(Ke=!0):(Ke=!0,Se.__version=G.version);let An=Se.currentProgram;Ke===!0&&(An=ko(G,N,F));let Pr=!1,on=!1,Wl=!1;const vt=An.getUniforms(),vi=Se.uniforms;if(xe.useProgram(An.program)&&(Pr=!0,on=!0,Wl=!0),G.id!==I&&(I=G.id,on=!0),Pr||M!==w){vt.setValue(L,"projectionMatrix",w.projectionMatrix),vt.setValue(L,"viewMatrix",w.matrixWorldInverse);const mn=vt.map.cameraPosition;mn!==void 0&&mn.setValue(L,ue.setFromMatrixPosition(w.matrixWorld)),je.logarithmicDepthBuffer&&vt.setValue(L,"logDepthBufFC",2/(Math.log(w.far+1)/Math.LN2)),(G.isMeshPhongMaterial||G.isMeshToonMaterial||G.isMeshLambertMaterial||G.isMeshBasicMaterial||G.isMeshStandardMaterial||G.isShaderMaterial)&&vt.setValue(L,"isOrthographic",w.isOrthographicCamera===!0),M!==w&&(M=w,on=!0,Wl=!0)}if(F.isSkinnedMesh){vt.setOptional(L,F,"bindMatrix"),vt.setOptional(L,F,"bindMatrixInverse");const mn=F.skeleton;mn&&(mn.boneTexture===null&&mn.computeBoneTexture(),vt.setValue(L,"boneTexture",mn.boneTexture,Ie))}F.isBatchedMesh&&(vt.setOptional(L,F,"batchingTexture"),vt.setValue(L,"batchingTexture",F._matricesTexture,Ie),vt.setOptional(L,F,"batchingIdTexture"),vt.setValue(L,"batchingIdTexture",F._indirectTexture,Ie),vt.setOptional(L,F,"batchingColorTexture"),F._colorsTexture!==null&&vt.setValue(L,"batchingColorTexture",F._colorsTexture,Ie));const Xl=H.morphAttributes;if((Xl.position!==void 0||Xl.normal!==void 0||Xl.color!==void 0)&&He.update(F,H,An),(on||Se.receiveShadow!==F.receiveShadow)&&(Se.receiveShadow=F.receiveShadow,vt.setValue(L,"receiveShadow",F.receiveShadow)),G.isMeshGouraudMaterial&&G.envMap!==null&&(vi.envMap.value=ve,vi.flipEnvMap.value=ve.isCubeTexture&&ve.isRenderTargetTexture===!1?-1:1),G.isMeshStandardMaterial&&G.envMap===null&&N.environment!==null&&(vi.envMapIntensity.value=N.environmentIntensity),on&&(vt.setValue(L,"toneMappingExposure",_.toneMappingExposure),Se.needsLights&&j_(vi,Wl),oe&&G.fog===!0&&Me.refreshFogUniforms(vi,oe),Me.refreshMaterialUniforms(vi,G,$,O,p.state.transmissionRenderTarget[w.id]),ja.upload(L,Id(Se),vi,Ie)),G.isShaderMaterial&&G.uniformsNeedUpdate===!0&&(ja.upload(L,Id(Se),vi,Ie),G.uniformsNeedUpdate=!1),G.isSpriteMaterial&&vt.setValue(L,"center",F.center),vt.setValue(L,"modelViewMatrix",F.modelViewMatrix),vt.setValue(L,"normalMatrix",F.normalMatrix),vt.setValue(L,"modelMatrix",F.matrixWorld),G.isShaderMaterial||G.isRawShaderMaterial){const mn=G.uniformsGroups;for(let jl=0,q_=mn.length;jl<q_;jl++){const Nd=mn[jl];rt.update(Nd,An),rt.bind(Nd,An)}}return An}function j_(w,N){w.ambientLightColor.needsUpdate=N,w.lightProbe.needsUpdate=N,w.directionalLights.needsUpdate=N,w.directionalLightShadows.needsUpdate=N,w.pointLights.needsUpdate=N,w.pointLightShadows.needsUpdate=N,w.spotLights.needsUpdate=N,w.spotLightShadows.needsUpdate=N,w.rectAreaLights.needsUpdate=N,w.hemisphereLights.needsUpdate=N}function Y_(w){return w.isMeshLambertMaterial||w.isMeshToonMaterial||w.isMeshPhongMaterial||w.isMeshStandardMaterial||w.isShadowMaterial||w.isShaderMaterial&&w.lights===!0}this.getActiveCubeFace=function(){return D},this.getActiveMipmapLevel=function(){return C},this.getRenderTarget=function(){return A},this.setRenderTargetTextures=function(w,N,H){Le.get(w.texture).__webglTexture=N,Le.get(w.depthTexture).__webglTexture=H;const G=Le.get(w);G.__hasExternalTextures=!0,G.__autoAllocateDepthBuffer=H===void 0,G.__autoAllocateDepthBuffer||Xe.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),G.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(w,N){const H=Le.get(w);H.__webglFramebuffer=N,H.__useDefaultFramebuffer=N===void 0},this.setRenderTarget=function(w,N=0,H=0){A=w,D=N,C=H;let G=!0,F=null,oe=!1,fe=!1;if(w){const ve=Le.get(w);ve.__useDefaultFramebuffer!==void 0?(xe.bindFramebuffer(L.FRAMEBUFFER,null),G=!1):ve.__webglFramebuffer===void 0?Ie.setupRenderTarget(w):ve.__hasExternalTextures&&Ie.rebindTextures(w,Le.get(w.texture).__webglTexture,Le.get(w.depthTexture).__webglTexture);const Ae=w.texture;(Ae.isData3DTexture||Ae.isDataArrayTexture||Ae.isCompressedArrayTexture)&&(fe=!0);const Pe=Le.get(w).__webglFramebuffer;w.isWebGLCubeRenderTarget?(Array.isArray(Pe[N])?F=Pe[N][H]:F=Pe[N],oe=!0):w.samples>0&&Ie.useMultisampledRTT(w)===!1?F=Le.get(w).__webglMultisampledFramebuffer:Array.isArray(Pe)?F=Pe[H]:F=Pe,v.copy(w.viewport),R.copy(w.scissor),X=w.scissorTest}else v.copy(Z).multiplyScalar($).floor(),R.copy(Q).multiplyScalar($).floor(),X=ge;if(xe.bindFramebuffer(L.FRAMEBUFFER,F)&&G&&xe.drawBuffers(w,F),xe.viewport(v),xe.scissor(R),xe.setScissorTest(X),oe){const ve=Le.get(w.texture);L.framebufferTexture2D(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_CUBE_MAP_POSITIVE_X+N,ve.__webglTexture,H)}else if(fe){const ve=Le.get(w.texture),Ae=N||0;L.framebufferTextureLayer(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0,ve.__webglTexture,H||0,Ae)}I=-1},this.readRenderTargetPixels=function(w,N,H,G,F,oe,fe){if(!(w&&w.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let _e=Le.get(w).__webglFramebuffer;if(w.isWebGLCubeRenderTarget&&fe!==void 0&&(_e=_e[fe]),_e){xe.bindFramebuffer(L.FRAMEBUFFER,_e);try{const ve=w.texture,Ae=ve.format,Pe=ve.type;if(!je.textureFormatReadable(Ae)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!je.textureTypeReadable(Pe)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}N>=0&&N<=w.width-G&&H>=0&&H<=w.height-F&&L.readPixels(N,H,G,F,Ce.convert(Ae),Ce.convert(Pe),oe)}finally{const ve=A!==null?Le.get(A).__webglFramebuffer:null;xe.bindFramebuffer(L.FRAMEBUFFER,ve)}}},this.readRenderTargetPixelsAsync=async function(w,N,H,G,F,oe,fe){if(!(w&&w.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let _e=Le.get(w).__webglFramebuffer;if(w.isWebGLCubeRenderTarget&&fe!==void 0&&(_e=_e[fe]),_e){xe.bindFramebuffer(L.FRAMEBUFFER,_e);try{const ve=w.texture,Ae=ve.format,Pe=ve.type;if(!je.textureFormatReadable(Ae))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!je.textureTypeReadable(Pe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(N>=0&&N<=w.width-G&&H>=0&&H<=w.height-F){const Te=L.createBuffer();L.bindBuffer(L.PIXEL_PACK_BUFFER,Te),L.bufferData(L.PIXEL_PACK_BUFFER,oe.byteLength,L.STREAM_READ),L.readPixels(N,H,G,F,Ce.convert(Ae),Ce.convert(Pe),0),L.flush();const Ye=L.fenceSync(L.SYNC_GPU_COMMANDS_COMPLETE,0);await vy(L,Ye,4);try{L.bindBuffer(L.PIXEL_PACK_BUFFER,Te),L.getBufferSubData(L.PIXEL_PACK_BUFFER,0,oe)}finally{L.deleteBuffer(Te),L.deleteSync(Ye)}return oe}}finally{const ve=A!==null?Le.get(A).__webglFramebuffer:null;xe.bindFramebuffer(L.FRAMEBUFFER,ve)}}},this.copyFramebufferToTexture=function(w,N=null,H=0){w.isTexture!==!0&&(console.warn("WebGLRenderer: copyFramebufferToTexture function signature has changed."),N=arguments[0]||null,w=arguments[1]);const G=Math.pow(2,-H),F=Math.floor(w.image.width*G),oe=Math.floor(w.image.height*G),fe=N!==null?N.x:0,_e=N!==null?N.y:0;Ie.setTexture2D(w,0),L.copyTexSubImage2D(L.TEXTURE_2D,H,0,0,fe,_e,F,oe),xe.unbindTexture()},this.copyTextureToTexture=function(w,N,H=null,G=null,F=0){w.isTexture!==!0&&(console.warn("WebGLRenderer: copyTextureToTexture function signature has changed."),G=arguments[0]||null,w=arguments[1],N=arguments[2],F=arguments[3]||0,H=null);let oe,fe,_e,ve,Ae,Pe;H!==null?(oe=H.max.x-H.min.x,fe=H.max.y-H.min.y,_e=H.min.x,ve=H.min.y):(oe=w.image.width,fe=w.image.height,_e=0,ve=0),G!==null?(Ae=G.x,Pe=G.y):(Ae=0,Pe=0);const Te=Ce.convert(N.format),Ye=Ce.convert(N.type);Ie.setTexture2D(N,0),L.pixelStorei(L.UNPACK_FLIP_Y_WEBGL,N.flipY),L.pixelStorei(L.UNPACK_PREMULTIPLY_ALPHA_WEBGL,N.premultiplyAlpha),L.pixelStorei(L.UNPACK_ALIGNMENT,N.unpackAlignment);const ft=L.getParameter(L.UNPACK_ROW_LENGTH),dt=L.getParameter(L.UNPACK_IMAGE_HEIGHT),sn=L.getParameter(L.UNPACK_SKIP_PIXELS),qe=L.getParameter(L.UNPACK_SKIP_ROWS),Se=L.getParameter(L.UNPACK_SKIP_IMAGES),It=w.isCompressedTexture?w.mipmaps[F]:w.image;L.pixelStorei(L.UNPACK_ROW_LENGTH,It.width),L.pixelStorei(L.UNPACK_IMAGE_HEIGHT,It.height),L.pixelStorei(L.UNPACK_SKIP_PIXELS,_e),L.pixelStorei(L.UNPACK_SKIP_ROWS,ve),w.isDataTexture?L.texSubImage2D(L.TEXTURE_2D,F,Ae,Pe,oe,fe,Te,Ye,It.data):w.isCompressedTexture?L.compressedTexSubImage2D(L.TEXTURE_2D,F,Ae,Pe,It.width,It.height,Te,It.data):L.texSubImage2D(L.TEXTURE_2D,F,Ae,Pe,oe,fe,Te,Ye,It),L.pixelStorei(L.UNPACK_ROW_LENGTH,ft),L.pixelStorei(L.UNPACK_IMAGE_HEIGHT,dt),L.pixelStorei(L.UNPACK_SKIP_PIXELS,sn),L.pixelStorei(L.UNPACK_SKIP_ROWS,qe),L.pixelStorei(L.UNPACK_SKIP_IMAGES,Se),F===0&&N.generateMipmaps&&L.generateMipmap(L.TEXTURE_2D),xe.unbindTexture()},this.copyTextureToTexture3D=function(w,N,H=null,G=null,F=0){w.isTexture!==!0&&(console.warn("WebGLRenderer: copyTextureToTexture3D function signature has changed."),H=arguments[0]||null,G=arguments[1]||null,w=arguments[2],N=arguments[3],F=arguments[4]||0);let oe,fe,_e,ve,Ae,Pe,Te,Ye,ft;const dt=w.isCompressedTexture?w.mipmaps[F]:w.image;H!==null?(oe=H.max.x-H.min.x,fe=H.max.y-H.min.y,_e=H.max.z-H.min.z,ve=H.min.x,Ae=H.min.y,Pe=H.min.z):(oe=dt.width,fe=dt.height,_e=dt.depth,ve=0,Ae=0,Pe=0),G!==null?(Te=G.x,Ye=G.y,ft=G.z):(Te=0,Ye=0,ft=0);const sn=Ce.convert(N.format),qe=Ce.convert(N.type);let Se;if(N.isData3DTexture)Ie.setTexture3D(N,0),Se=L.TEXTURE_3D;else if(N.isDataArrayTexture||N.isCompressedArrayTexture)Ie.setTexture2DArray(N,0),Se=L.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}L.pixelStorei(L.UNPACK_FLIP_Y_WEBGL,N.flipY),L.pixelStorei(L.UNPACK_PREMULTIPLY_ALPHA_WEBGL,N.premultiplyAlpha),L.pixelStorei(L.UNPACK_ALIGNMENT,N.unpackAlignment);const It=L.getParameter(L.UNPACK_ROW_LENGTH),Ke=L.getParameter(L.UNPACK_IMAGE_HEIGHT),An=L.getParameter(L.UNPACK_SKIP_PIXELS),Pr=L.getParameter(L.UNPACK_SKIP_ROWS),on=L.getParameter(L.UNPACK_SKIP_IMAGES);L.pixelStorei(L.UNPACK_ROW_LENGTH,dt.width),L.pixelStorei(L.UNPACK_IMAGE_HEIGHT,dt.height),L.pixelStorei(L.UNPACK_SKIP_PIXELS,ve),L.pixelStorei(L.UNPACK_SKIP_ROWS,Ae),L.pixelStorei(L.UNPACK_SKIP_IMAGES,Pe),w.isDataTexture||w.isData3DTexture?L.texSubImage3D(Se,F,Te,Ye,ft,oe,fe,_e,sn,qe,dt.data):N.isCompressedArrayTexture?L.compressedTexSubImage3D(Se,F,Te,Ye,ft,oe,fe,_e,sn,dt.data):L.texSubImage3D(Se,F,Te,Ye,ft,oe,fe,_e,sn,qe,dt),L.pixelStorei(L.UNPACK_ROW_LENGTH,It),L.pixelStorei(L.UNPACK_IMAGE_HEIGHT,Ke),L.pixelStorei(L.UNPACK_SKIP_PIXELS,An),L.pixelStorei(L.UNPACK_SKIP_ROWS,Pr),L.pixelStorei(L.UNPACK_SKIP_IMAGES,on),F===0&&N.generateMipmaps&&L.generateMipmap(Se),xe.unbindTexture()},this.initRenderTarget=function(w){Le.get(w).__webglFramebuffer===void 0&&Ie.setupRenderTarget(w)},this.initTexture=function(w){w.isCubeTexture?Ie.setTextureCube(w,0):w.isData3DTexture?Ie.setTexture3D(w,0):w.isDataArrayTexture||w.isCompressedArrayTexture?Ie.setTexture2DArray(w,0):Ie.setTexture2D(w,0),xe.unbindTexture()},this.resetState=function(){D=0,C=0,A=null,xe.reset(),De.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return li}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const n=this.getContext();n.drawingBufferColorSpace=e===Rd?"display-p3":"srgb",n.unpackColorSpace=$e.workingColorSpace===Bl?"display-p3":"srgb"}}class Cw extends Ft{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new Kn,this.environmentIntensity=1,this.environmentRotation=new Kn,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,n){return super.copy(e,n),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,this.backgroundRotation.copy(e.backgroundRotation),this.environmentIntensity=e.environmentIntensity,this.environmentRotation.copy(e.environmentRotation),e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const n=super.toJSON(e);return this.fog!==null&&(n.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(n.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(n.object.backgroundIntensity=this.backgroundIntensity),n.object.backgroundRotation=this.backgroundRotation.toArray(),this.environmentIntensity!==1&&(n.object.environmentIntensity=this.environmentIntensity),n.object.environmentRotation=this.environmentRotation.toArray(),n}}class G_ extends Is{constructor(e){super(),this.isPointsMaterial=!0,this.type="PointsMaterial",this.color=new Ve(16777215),this.map=null,this.alphaMap=null,this.size=1,this.sizeAttenuation=!0,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.alphaMap=e.alphaMap,this.size=e.size,this.sizeAttenuation=e.sizeAttenuation,this.fog=e.fog,this}}const Hp=new pt,wf=new Pd,wa=new Hl,Aa=new k;class Rw extends Ft{constructor(e=new gi,n=new G_){super(),this.isPoints=!0,this.type="Points",this.geometry=e,this.material=n,this.updateMorphTargets()}copy(e,n){return super.copy(e,n),this.material=Array.isArray(e.material)?e.material.slice():e.material,this.geometry=e.geometry,this}raycast(e,n){const i=this.geometry,r=this.matrixWorld,s=e.params.Points.threshold,o=i.drawRange;if(i.boundingSphere===null&&i.computeBoundingSphere(),wa.copy(i.boundingSphere),wa.applyMatrix4(r),wa.radius+=s,e.ray.intersectsSphere(wa)===!1)return;Hp.copy(r).invert(),wf.copy(e.ray).applyMatrix4(Hp);const a=s/((this.scale.x+this.scale.y+this.scale.z)/3),l=a*a,u=i.index,h=i.attributes.position;if(u!==null){const d=Math.max(0,o.start),m=Math.min(u.count,o.start+o.count);for(let x=d,S=m;x<S;x++){const p=u.getX(x);Aa.fromBufferAttribute(h,p),Vp(Aa,p,l,r,e,n,this)}}else{const d=Math.max(0,o.start),m=Math.min(h.count,o.start+o.count);for(let x=d,S=m;x<S;x++)Aa.fromBufferAttribute(h,x),Vp(Aa,x,l,r,e,n,this)}}updateMorphTargets(){const n=this.geometry.morphAttributes,i=Object.keys(n);if(i.length>0){const r=n[i[0]];if(r!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let s=0,o=r.length;s<o;s++){const a=r[s].name||String(s);this.morphTargetInfluences.push(0),this.morphTargetDictionary[a]=s}}}}}function Vp(t,e,n,i,r,s,o){const a=wf.distanceSqToPoint(t);if(a<n){const l=new k;wf.closestPointToPoint(t,l),l.applyMatrix4(i);const u=r.ray.origin.distanceTo(l);if(u<r.near||u>r.far)return;s.push({distance:u,distanceToRay:Math.sqrt(a),point:l,index:e,face:null,object:o})}}class Pw extends Is{constructor(e){super(),this.isMeshPhongMaterial=!0,this.type="MeshPhongMaterial",this.color=new Ve(16777215),this.specular=new Ve(1118481),this.shininess=30,this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new Ve(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=M_,this.normalScale=new Ue(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.specularMap=null,this.alphaMap=null,this.envMap=null,this.envMapRotation=new Kn,this.combine=Sd,this.reflectivity=1,this.refractionRatio=.98,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.specular.copy(e.specular),this.shininess=e.shininess,this.map=e.map,this.lightMap=e.lightMap,this.lightMapIntensity=e.lightMapIntensity,this.aoMap=e.aoMap,this.aoMapIntensity=e.aoMapIntensity,this.emissive.copy(e.emissive),this.emissiveMap=e.emissiveMap,this.emissiveIntensity=e.emissiveIntensity,this.bumpMap=e.bumpMap,this.bumpScale=e.bumpScale,this.normalMap=e.normalMap,this.normalMapType=e.normalMapType,this.normalScale.copy(e.normalScale),this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.specularMap=e.specularMap,this.alphaMap=e.alphaMap,this.envMap=e.envMap,this.envMapRotation.copy(e.envMapRotation),this.combine=e.combine,this.reflectivity=e.reflectivity,this.refractionRatio=e.refractionRatio,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this.wireframeLinecap=e.wireframeLinecap,this.wireframeLinejoin=e.wireframeLinejoin,this.flatShading=e.flatShading,this.fog=e.fog,this}}class W_ extends Ft{constructor(e,n=1){super(),this.isLight=!0,this.type="Light",this.color=new Ve(e),this.intensity=n}dispose(){}copy(e,n){return super.copy(e,n),this.color.copy(e.color),this.intensity=e.intensity,this}toJSON(e){const n=super.toJSON(e);return n.object.color=this.color.getHex(),n.object.intensity=this.intensity,this.groundColor!==void 0&&(n.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(n.object.distance=this.distance),this.angle!==void 0&&(n.object.angle=this.angle),this.decay!==void 0&&(n.object.decay=this.decay),this.penumbra!==void 0&&(n.object.penumbra=this.penumbra),this.shadow!==void 0&&(n.object.shadow=this.shadow.toJSON()),this.target!==void 0&&(n.object.target=this.target.uuid),n}}const ju=new pt,Gp=new k,Wp=new k;class bw{constructor(e){this.camera=e,this.intensity=1,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new Ue(512,512),this.map=null,this.mapPass=null,this.matrix=new pt,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new bd,this._frameExtents=new Ue(1,1),this._viewportCount=1,this._viewports=[new wt(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(e){const n=this.camera,i=this.matrix;Gp.setFromMatrixPosition(e.matrixWorld),n.position.copy(Gp),Wp.setFromMatrixPosition(e.target.matrixWorld),n.lookAt(Wp),n.updateMatrixWorld(),ju.multiplyMatrices(n.projectionMatrix,n.matrixWorldInverse),this._frustum.setFromProjectionMatrix(ju),i.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),i.multiply(ju)}getViewport(e){return this._viewports[e]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(e){return this.camera=e.camera.clone(),this.intensity=e.intensity,this.bias=e.bias,this.radius=e.radius,this.mapSize.copy(e.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const e={};return this.intensity!==1&&(e.intensity=this.intensity),this.bias!==0&&(e.bias=this.bias),this.normalBias!==0&&(e.normalBias=this.normalBias),this.radius!==1&&(e.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(e.mapSize=this.mapSize.toArray()),e.camera=this.camera.toJSON(!1).object,delete e.camera.matrix,e}}class Lw extends bw{constructor(){super(new O_(-5,5,5,-5,.5,500)),this.isDirectionalLightShadow=!0}}class Xp extends W_{constructor(e,n){super(e,n),this.isDirectionalLight=!0,this.type="DirectionalLight",this.position.copy(Ft.DEFAULT_UP),this.updateMatrix(),this.target=new Ft,this.shadow=new Lw}dispose(){this.shadow.dispose()}copy(e){return super.copy(e),this.target=e.target.clone(),this.shadow=e.shadow.clone(),this}}class Dw extends W_{constructor(e,n){super(e,n),this.isAmbientLight=!0,this.type="AmbientLight"}}class jp{constructor(e=1,n=0,i=0){return this.radius=e,this.phi=n,this.theta=i,this}set(e,n,i){return this.radius=e,this.phi=n,this.theta=i,this}copy(e){return this.radius=e.radius,this.phi=e.phi,this.theta=e.theta,this}makeSafe(){return this.phi=Math.max(1e-6,Math.min(Math.PI-1e-6,this.phi)),this}setFromVector3(e){return this.setFromCartesianCoords(e.x,e.y,e.z)}setFromCartesianCoords(e,n,i){return this.radius=Math.sqrt(e*e+n*n+i*i),this.radius===0?(this.theta=0,this.phi=0):(this.theta=Math.atan2(e,i),this.phi=Math.acos(jt(n/this.radius,-1,1))),this}clone(){return new this.constructor().copy(this)}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:yd}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=yd);const Yp={type:"change"},Yu={type:"start"},qp={type:"end"},Ca=new Pd,Kp=new Ri,Iw=Math.cos(70*gy.DEG2RAD);class Uw extends Rr{constructor(e,n){super(),this.object=e,this.domElement=n,this.domElement.style.touchAction="none",this.enabled=!0,this.target=new k,this.cursor=new k,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:Lr.ROTATE,MIDDLE:Lr.DOLLY,RIGHT:Lr.PAN},this.touches={ONE:Dr.ROTATE,TWO:Dr.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this.getPolarAngle=function(){return a.phi},this.getAzimuthalAngle=function(){return a.theta},this.getDistance=function(){return this.object.position.distanceTo(this.target)},this.listenToKeyEvents=function(y){y.addEventListener("keydown",de),this._domElementKeyEvents=y},this.stopListenToKeyEvents=function(){this._domElementKeyEvents.removeEventListener("keydown",de),this._domElementKeyEvents=null},this.saveState=function(){i.target0.copy(i.target),i.position0.copy(i.object.position),i.zoom0=i.object.zoom},this.reset=function(){i.target.copy(i.target0),i.object.position.copy(i.position0),i.object.zoom=i.zoom0,i.object.updateProjectionMatrix(),i.dispatchEvent(Yp),i.update(),s=r.NONE},this.update=function(){const y=new k,z=new wr().setFromUnitVectors(e.up,new k(0,1,0)),B=z.clone().invert(),q=new k,ne=new wr,ye=new k,Re=2*Math.PI;return function(St=null){const Ge=i.object.position;y.copy(Ge).sub(i.target),y.applyQuaternion(z),a.setFromVector3(y),i.autoRotate&&s===r.NONE&&X(v(St)),i.enableDamping?(a.theta+=l.theta*i.dampingFactor,a.phi+=l.phi*i.dampingFactor):(a.theta+=l.theta,a.phi+=l.phi);let Mt=i.minAzimuthAngle,_t=i.maxAzimuthAngle;isFinite(Mt)&&isFinite(_t)&&(Mt<-Math.PI?Mt+=Re:Mt>Math.PI&&(Mt-=Re),_t<-Math.PI?_t+=Re:_t>Math.PI&&(_t-=Re),Mt<=_t?a.theta=Math.max(Mt,Math.min(_t,a.theta)):a.theta=a.theta>(Mt+_t)/2?Math.max(Mt,a.theta):Math.min(_t,a.theta)),a.phi=Math.max(i.minPolarAngle,Math.min(i.maxPolarAngle,a.phi)),a.makeSafe(),i.enableDamping===!0?i.target.addScaledVector(f,i.dampingFactor):i.target.add(f),i.target.sub(i.cursor),i.target.clampLength(i.minTargetRadius,i.maxTargetRadius),i.target.add(i.cursor);let _i=!1;if(i.zoomToCursor&&C||i.object.isOrthographicCamera)a.radius=Z(a.radius);else{const Dt=a.radius;a.radius=Z(a.radius*u),_i=Dt!=a.radius}if(y.setFromSpherical(a),y.applyQuaternion(B),Ge.copy(i.target).add(y),i.object.lookAt(i.target),i.enableDamping===!0?(l.theta*=1-i.dampingFactor,l.phi*=1-i.dampingFactor,f.multiplyScalar(1-i.dampingFactor)):(l.set(0,0,0),f.set(0,0,0)),i.zoomToCursor&&C){let Dt=null;if(i.object.isPerspectiveCamera){const $n=y.length();Dt=Z($n*u);const Qi=$n-Dt;i.object.position.addScaledVector(T,Qi),i.object.updateMatrixWorld(),_i=!!Qi}else if(i.object.isOrthographicCamera){const $n=new k(D.x,D.y,0);$n.unproject(i.object);const Qi=i.object.zoom;i.object.zoom=Math.max(i.minZoom,Math.min(i.maxZoom,i.object.zoom/u)),i.object.updateProjectionMatrix(),_i=Qi!==i.object.zoom;const Ns=new k(D.x,D.y,0);Ns.unproject(i.object),i.object.position.sub(Ns).add($n),i.object.updateMatrixWorld(),Dt=y.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),i.zoomToCursor=!1;Dt!==null&&(this.screenSpacePanning?i.target.set(0,0,-1).transformDirection(i.object.matrix).multiplyScalar(Dt).add(i.object.position):(Ca.origin.copy(i.object.position),Ca.direction.set(0,0,-1).transformDirection(i.object.matrix),Math.abs(i.object.up.dot(Ca.direction))<Iw?e.lookAt(i.target):(Kp.setFromNormalAndCoplanarPoint(i.object.up,i.target),Ca.intersectPlane(Kp,i.target))))}else if(i.object.isOrthographicCamera){const Dt=i.object.zoom;i.object.zoom=Math.max(i.minZoom,Math.min(i.maxZoom,i.object.zoom/u)),Dt!==i.object.zoom&&(i.object.updateProjectionMatrix(),_i=!0)}return u=1,C=!1,_i||q.distanceToSquared(i.object.position)>o||8*(1-ne.dot(i.object.quaternion))>o||ye.distanceToSquared(i.target)>o?(i.dispatchEvent(Yp),q.copy(i.object.position),ne.copy(i.object.quaternion),ye.copy(i.target),!0):!1}}(),this.dispose=function(){i.domElement.removeEventListener("contextmenu",he),i.domElement.removeEventListener("pointerdown",Ie),i.domElement.removeEventListener("pointercancel",E),i.domElement.removeEventListener("wheel",ie),i.domElement.removeEventListener("pointermove",P),i.domElement.removeEventListener("pointerup",E),i.domElement.getRootNode().removeEventListener("keydown",Me,{capture:!0}),i._domElementKeyEvents!==null&&(i._domElementKeyEvents.removeEventListener("keydown",de),i._domElementKeyEvents=null)};const i=this,r={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6};let s=r.NONE;const o=1e-6,a=new jp,l=new jp;let u=1;const f=new k,h=new Ue,d=new Ue,m=new Ue,x=new Ue,S=new Ue,p=new Ue,c=new Ue,g=new Ue,_=new Ue,T=new k,D=new Ue;let C=!1;const A=[],I={};let M=!1;function v(y){return y!==null?2*Math.PI/60*i.autoRotateSpeed*y:2*Math.PI/60/60*i.autoRotateSpeed}function R(y){const z=Math.abs(y*.01);return Math.pow(.95,i.zoomSpeed*z)}function X(y){l.theta-=y}function U(y){l.phi-=y}const K=function(){const y=new k;return function(B,q){y.setFromMatrixColumn(q,0),y.multiplyScalar(-B),f.add(y)}}(),j=function(){const y=new k;return function(B,q){i.screenSpacePanning===!0?y.setFromMatrixColumn(q,1):(y.setFromMatrixColumn(q,0),y.crossVectors(i.object.up,y)),y.multiplyScalar(B),f.add(y)}}(),O=function(){const y=new k;return function(B,q){const ne=i.domElement;if(i.object.isPerspectiveCamera){const ye=i.object.position;y.copy(ye).sub(i.target);let Re=y.length();Re*=Math.tan(i.object.fov/2*Math.PI/180),K(2*B*Re/ne.clientHeight,i.object.matrix),j(2*q*Re/ne.clientHeight,i.object.matrix)}else i.object.isOrthographicCamera?(K(B*(i.object.right-i.object.left)/i.object.zoom/ne.clientWidth,i.object.matrix),j(q*(i.object.top-i.object.bottom)/i.object.zoom/ne.clientHeight,i.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),i.enablePan=!1)}}();function $(y){i.object.isPerspectiveCamera||i.object.isOrthographicCamera?u/=y:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),i.enableZoom=!1)}function b(y){i.object.isPerspectiveCamera||i.object.isOrthographicCamera?u*=y:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),i.enableZoom=!1)}function Y(y,z){if(!i.zoomToCursor)return;C=!0;const B=i.domElement.getBoundingClientRect(),q=y-B.left,ne=z-B.top,ye=B.width,Re=B.height;D.x=q/ye*2-1,D.y=-(ne/Re)*2+1,T.set(D.x,D.y,1).unproject(i.object).sub(i.object.position).normalize()}function Z(y){return Math.max(i.minDistance,Math.min(i.maxDistance,y))}function Q(y){h.set(y.clientX,y.clientY)}function ge(y){Y(y.clientX,y.clientX),c.set(y.clientX,y.clientY)}function Ee(y){x.set(y.clientX,y.clientY)}function V(y){d.set(y.clientX,y.clientY),m.subVectors(d,h).multiplyScalar(i.rotateSpeed);const z=i.domElement;X(2*Math.PI*m.x/z.clientHeight),U(2*Math.PI*m.y/z.clientHeight),h.copy(d),i.update()}function ee(y){g.set(y.clientX,y.clientY),_.subVectors(g,c),_.y>0?$(R(_.y)):_.y<0&&b(R(_.y)),c.copy(g),i.update()}function ce(y){S.set(y.clientX,y.clientY),p.subVectors(S,x).multiplyScalar(i.panSpeed),O(p.x,p.y),x.copy(S),i.update()}function ue(y){Y(y.clientX,y.clientY),y.deltaY<0?b(R(y.deltaY)):y.deltaY>0&&$(R(y.deltaY)),i.update()}function be(y){let z=!1;switch(y.code){case i.keys.UP:y.ctrlKey||y.metaKey||y.shiftKey?U(2*Math.PI*i.rotateSpeed/i.domElement.clientHeight):O(0,i.keyPanSpeed),z=!0;break;case i.keys.BOTTOM:y.ctrlKey||y.metaKey||y.shiftKey?U(-2*Math.PI*i.rotateSpeed/i.domElement.clientHeight):O(0,-i.keyPanSpeed),z=!0;break;case i.keys.LEFT:y.ctrlKey||y.metaKey||y.shiftKey?X(2*Math.PI*i.rotateSpeed/i.domElement.clientHeight):O(i.keyPanSpeed,0),z=!0;break;case i.keys.RIGHT:y.ctrlKey||y.metaKey||y.shiftKey?X(-2*Math.PI*i.rotateSpeed/i.domElement.clientHeight):O(-i.keyPanSpeed,0),z=!0;break}z&&(y.preventDefault(),i.update())}function Fe(y){if(A.length===1)h.set(y.pageX,y.pageY);else{const z=De(y),B=.5*(y.pageX+z.x),q=.5*(y.pageY+z.y);h.set(B,q)}}function ze(y){if(A.length===1)x.set(y.pageX,y.pageY);else{const z=De(y),B=.5*(y.pageX+z.x),q=.5*(y.pageY+z.y);x.set(B,q)}}function Je(y){const z=De(y),B=y.pageX-z.x,q=y.pageY-z.y,ne=Math.sqrt(B*B+q*q);c.set(0,ne)}function L(y){i.enableZoom&&Je(y),i.enablePan&&ze(y)}function ut(y){i.enableZoom&&Je(y),i.enableRotate&&Fe(y)}function Xe(y){if(A.length==1)d.set(y.pageX,y.pageY);else{const B=De(y),q=.5*(y.pageX+B.x),ne=.5*(y.pageY+B.y);d.set(q,ne)}m.subVectors(d,h).multiplyScalar(i.rotateSpeed);const z=i.domElement;X(2*Math.PI*m.x/z.clientHeight),U(2*Math.PI*m.y/z.clientHeight),h.copy(d)}function je(y){if(A.length===1)S.set(y.pageX,y.pageY);else{const z=De(y),B=.5*(y.pageX+z.x),q=.5*(y.pageY+z.y);S.set(B,q)}p.subVectors(S,x).multiplyScalar(i.panSpeed),O(p.x,p.y),x.copy(S)}function xe(y){const z=De(y),B=y.pageX-z.x,q=y.pageY-z.y,ne=Math.sqrt(B*B+q*q);g.set(0,ne),_.set(0,Math.pow(g.y/c.y,i.zoomSpeed)),$(_.y),c.copy(g);const ye=(y.pageX+z.x)*.5,Re=(y.pageY+z.y)*.5;Y(ye,Re)}function ct(y){i.enableZoom&&xe(y),i.enablePan&&je(y)}function Le(y){i.enableZoom&&xe(y),i.enableRotate&&Xe(y)}function Ie(y){i.enabled!==!1&&(A.length===0&&(i.domElement.setPointerCapture(y.pointerId),i.domElement.addEventListener("pointermove",P),i.domElement.addEventListener("pointerup",E)),!me(y)&&(He(y),y.pointerType==="touch"?Ne(y):W(y)))}function P(y){i.enabled!==!1&&(y.pointerType==="touch"?se(y):te(y))}function E(y){switch(we(y),A.length){case 0:i.domElement.releasePointerCapture(y.pointerId),i.domElement.removeEventListener("pointermove",P),i.domElement.removeEventListener("pointerup",E),i.dispatchEvent(qp),s=r.NONE;break;case 1:const z=A[0],B=I[z];Ne({pointerId:z,pageX:B.x,pageY:B.y});break}}function W(y){let z;switch(y.button){case 0:z=i.mouseButtons.LEFT;break;case 1:z=i.mouseButtons.MIDDLE;break;case 2:z=i.mouseButtons.RIGHT;break;default:z=-1}switch(z){case Lr.DOLLY:if(i.enableZoom===!1)return;ge(y),s=r.DOLLY;break;case Lr.ROTATE:if(y.ctrlKey||y.metaKey||y.shiftKey){if(i.enablePan===!1)return;Ee(y),s=r.PAN}else{if(i.enableRotate===!1)return;Q(y),s=r.ROTATE}break;case Lr.PAN:if(y.ctrlKey||y.metaKey||y.shiftKey){if(i.enableRotate===!1)return;Q(y),s=r.ROTATE}else{if(i.enablePan===!1)return;Ee(y),s=r.PAN}break;default:s=r.NONE}s!==r.NONE&&i.dispatchEvent(Yu)}function te(y){switch(s){case r.ROTATE:if(i.enableRotate===!1)return;V(y);break;case r.DOLLY:if(i.enableZoom===!1)return;ee(y);break;case r.PAN:if(i.enablePan===!1)return;ce(y);break}}function ie(y){i.enabled===!1||i.enableZoom===!1||s!==r.NONE||(y.preventDefault(),i.dispatchEvent(Yu),ue(J(y)),i.dispatchEvent(qp))}function J(y){const z=y.deltaMode,B={clientX:y.clientX,clientY:y.clientY,deltaY:y.deltaY};switch(z){case 1:B.deltaY*=16;break;case 2:B.deltaY*=100;break}return y.ctrlKey&&!M&&(B.deltaY*=10),B}function Me(y){y.key==="Control"&&(M=!0,i.domElement.getRootNode().addEventListener("keyup",ae,{passive:!0,capture:!0}))}function ae(y){y.key==="Control"&&(M=!1,i.domElement.getRootNode().removeEventListener("keyup",ae,{passive:!0,capture:!0}))}function de(y){i.enabled===!1||i.enablePan===!1||be(y)}function Ne(y){switch(Ce(y),A.length){case 1:switch(i.touches.ONE){case Dr.ROTATE:if(i.enableRotate===!1)return;Fe(y),s=r.TOUCH_ROTATE;break;case Dr.PAN:if(i.enablePan===!1)return;ze(y),s=r.TOUCH_PAN;break;default:s=r.NONE}break;case 2:switch(i.touches.TWO){case Dr.DOLLY_PAN:if(i.enableZoom===!1&&i.enablePan===!1)return;L(y),s=r.TOUCH_DOLLY_PAN;break;case Dr.DOLLY_ROTATE:if(i.enableZoom===!1&&i.enableRotate===!1)return;ut(y),s=r.TOUCH_DOLLY_ROTATE;break;default:s=r.NONE}break;default:s=r.NONE}s!==r.NONE&&i.dispatchEvent(Yu)}function se(y){switch(Ce(y),s){case r.TOUCH_ROTATE:if(i.enableRotate===!1)return;Xe(y),i.update();break;case r.TOUCH_PAN:if(i.enablePan===!1)return;je(y),i.update();break;case r.TOUCH_DOLLY_PAN:if(i.enableZoom===!1&&i.enablePan===!1)return;ct(y),i.update();break;case r.TOUCH_DOLLY_ROTATE:if(i.enableZoom===!1&&i.enableRotate===!1)return;Le(y),i.update();break;default:s=r.NONE}}function he(y){i.enabled!==!1&&y.preventDefault()}function He(y){A.push(y.pointerId)}function we(y){delete I[y.pointerId];for(let z=0;z<A.length;z++)if(A[z]==y.pointerId){A.splice(z,1);return}}function me(y){for(let z=0;z<A.length;z++)if(A[z]==y.pointerId)return!0;return!1}function Ce(y){let z=I[y.pointerId];z===void 0&&(z=new Ue,I[y.pointerId]=z),z.set(y.pageX,y.pageY)}function De(y){const z=y.pointerId===A[0]?A[1]:A[0];return I[z]}i.domElement.addEventListener("contextmenu",he),i.domElement.addEventListener("pointerdown",Ie),i.domElement.addEventListener("pointercancel",E),i.domElement.addEventListener("wheel",ie,{passive:!1}),i.domElement.getRootNode().addEventListener("keydown",Me,{passive:!0,capture:!0}),this.update()}}const $p="/zspace_agent/",Nw="",Zp=[{id:"google",name:"Google Gemini (default key)"},{id:"openai",name:"OpenAI Chat Completions"},{id:"claude",name:"Anthropic Claude"}],qu=`
...
`,Fw={vertices:new Float32Array([-.6,-.6,-.6,.6,-.6,-.6,.6,.6,-.6,-.6,.6,-.6,-.6,-.6,.3,.6,-.6,.3,.6,.6,.3,-.6,.6,.3]),faces:[[0,1,2],[0,2,3],[4,5,6],[4,6,7],[0,1,5],[0,5,4],[2,3,7],[2,7,6],[1,2,6],[1,6,5],[0,3,7],[0,7,4]]},Ku=`#include <emscripten/emscripten.h>
...
}`}function Bw(){const[t,e]=Et.useState("Scale the block to emphasize curvature."),[n,i]=Et.useState(Nw),[r,s]=Et.useState(Zp[0].id),[o,a]=Et.useState(""),[l,u]=Et.useState("Idle"),[f,h]=Et.useState(Fw),[d,m]=Et.useState(null),x=Et.useRef({}),S=Et.useRef(),p=Et.useRef(),c=Et.useRef(),g=Et.useRef(),_=Et.useRef();Et.useEffect(()=>{const M=document.createElement("script");return M.src=`${$p}geometry_engine.js`,M.onload=async()=>{if(window.createGeometryModule)try{const v=await window.createGeometryModule({locateFile:()=>`${$p}geometry_engine.wasm`});x.current={module:v,scale:v.cwrap("mesh_scale",null,["number","number","number"]),translate:v.cwrap("mesh_translate",null,["number","number","number","number","number"]),center:v.cwrap("mesh_center",null,["number","number"]),twist:v.cwrap("mesh_twist",null,["number","number","number"])},m(v),u("Geometry engine ready.")}catch(v){console.warn("WASM load failed, using JS fallback:",v),m("js-fallback"),u("Using JS geometry fallback.")}},M.onerror=()=>{console.warn("WASM script not found, using JS fallback."),m("js-fallback"),u("Using JS geometry fallback.")},document.body.appendChild(M),()=>{document.body.contains(M)&&document.body.removeChild(M)}},[]),Et.useEffect(()=>{const M=S.current;if(!M)return;const v=new Cw;v.background=new Ve(1120295),p.current=v;const R=M.clientWidth||600,X=M.clientHeight||400,U=new Aw({antialias:!0});U.setPixelRatio(Math.min(window.devicePixelRatio,2)),U.setSize(R,X),U.shadowMap.enabled=!0,M.innerHTML="",M.appendChild(U.domElement),c.current=U;const K=new xn(50,R/X,.01,1e3);K.position.set(2,1.5,3),K.lookAt(0,0,0),g.current=K;const j=new Uw(K,U.domElement);j.enableDamping=!0,j.dampingFactor=.05,_.current=j,v.add(new Dw(16777215,.6));const O=new Xp(16777215,1.2);O.position.set(5,8,5),v.add(O);const $=new Xp(8952319,.4);$.position.set(-5,-2,-5),v.add($);let b;const Y=()=>{b=requestAnimationFrame(Y),j.update(),U.render(v,K)};Y();const Z=()=>{if(!c.current||!g.current||!M)return;const Q=M.clientWidth||600,ge=M.clientHeight||400;c.current.setSize(Q,ge),g.current.aspect=Q/ge,g.current.updateProjectionMatrix()};return window.addEventListener("resize",Z),()=>{cancelAnimationFrame(b),window.removeEventListener("resize",Z),U.dispose(),j.dispose()}},[]),Et.useEffect(()=>{if(!p.current)return;const M=p.current.getObjectByName("result-mesh");M&&(p.current.remove(M),M.geometry.dispose(),M.material.dispose());const v=f==null?void 0:f.vertices;if(!(!v||v.length<9))try{const R=new gi,X=f.faces??[];if(X.length>0){const j=[];for(const O of X){const[$,b,Y]=O;j.push(v[$*3],v[$*3+1],v[$*3+2],v[b*3],v[b*3+1],v[b*3+2],v[Y*3],v[Y*3+1],v[Y*3+2])}R.setAttribute("position",new En(new Float32Array(j),3)),R.computeVertexNormals()}else R.setAttribute("position",new En(new Float32Array(v),3));if(R.computeBoundingSphere(),R.boundingSphere&&g.current){const j=Math.max(R.boundingSphere.radius,.5),O=R.boundingSphere.center;g.current.position.set(O.x+j*2,O.y+j*1.5,O.z+j*3),g.current.lookAt(O.x,O.y,O.z),_.current&&(_.current.target.set(O.x,O.y,O.z),_.current.update())}const U=new Pw({color:4491519,specular:2245768,shininess:40,side:Wn}),K=X.length>0?new jn(R,U):new Rw(R,new G_({color:4491519,size:.05}));K.name="result-mesh",p.current.add(K)}catch(R){console.error("Geometry build error:",R)}},[f]);const T=(M,v)=>{const R=x.current;if(R&&R.module&&typeof R.module._malloc=="function"){const j=M.length*4,O=R.module._malloc(j);switch(R.module.HEAPF32.set(M,O/4),v.type){case"scale":R.scale(O,M.length,v.value);break;case"translate":{const[Y,Z,Q]=v.vector;R.translate(O,M.length,Y,Z,Q);break}case"center":R.center(O,M.length);break;case"twist":R.twist(O,M.length,v.strength);break}const $=O>>2,b=new Float32Array(R.module.HEAPF32.subarray($,$+M.length));return R.module._free(O),b}const U=new Float32Array(M),K=U.length/3;if(v.type==="scale"){const j=v.value??1;for(let O=0;O<U.length;O++)U[O]*=j}else if(v.type==="translate"){const[j,O,$]=v.vector??[0,0,0];for(let b=0;b<K;b++)U[b*3]+=j,U[b*3+1]+=O,U[b*3+2]+=$}else if(v.type==="center"){let j=0,O=0,$=0;for(let b=0;b<K;b++)j+=U[b*3],O+=U[b*3+1],$+=U[b*3+2];j/=K,O/=K,$/=K;for(let b=0;b<K;b++)U[b*3]-=j,U[b*3+1]-=O,U[b*3+2]-=$}else if(v.type==="twist"){const j=v.strength??.5;let O=1/0,$=-1/0;for(let Y=0;Y<K;Y++)O=Math.min(O,U[Y*3+1]),$=Math.max($,U[Y*3+1]);const b=$-O||1;for(let Y=0;Y<K;Y++){const Q=(U[Y*3+1]-O)/b*j,ge=U[Y*3],Ee=U[Y*3+2];U[Y*3]=ge*Math.cos(Q)-Ee*Math.sin(Q),U[Y*3+2]=ge*Math.sin(Q)+Ee*Math.cos(Q)}}return U},D=M=>{let v=new Float32Array(f.vertices);for(const R of M)v=T(v,R);h(R=>({...R,vertices:v}))},C=()=>{const M=zw(f),v=new Blob([M],{type:"text/plain"}),R=document.createElement("a");R.href=URL.createObjectURL(v),R.download="processed_mesh.usd",R.click(),URL.revokeObjectURL(R.href)},A=async()=>{var R,X,U,K,j,O,$,b,Y,Z;if(!n.trim()){u("⚠️ Please enter your API key before generating.");return}u("Calling LLM...");let M=null,v="";try{let Q="";if(r==="openai"){const Ee=await fetch("https://api.openai.com/v1/chat/completions",{method:"POST",headers:{Authorization:`Bearer ${n}`,"Content-Type":"application/json"},body:JSON.stringify({model:"gpt-4o-mini",temperature:.2,messages:[{role:"system",content:qu},{role:"user",content:t}]})});if(!Ee.ok)throw new Error(`OpenAI ${Ee.status}`);Q=((U=(X=(R=(await Ee.json()).choices)==null?void 0:R[0])==null?void 0:X.message)==null?void 0:U.content)??""}else if(r==="google"){const Ee=["gemini-2.0-flash","gemini-1.5-flash","gemini-1.5-pro","gemini-pro"];let V=null,ee="";for(const ue of Ee){const be=`https://generativelanguage.googleapis.com/v1beta/models/${ue}:generateContent?key=${n}`;if(V=await fetch(be,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contents:[{parts:[{text:`${qu}

User request: ${t}`}]}],generationConfig:{temperature:.2}})}),V.ok){u(`Using model: ${ue}`);break}ee=await V.text(),V=null}if(!V)throw new Error(`All Gemini models failed. Last error: ${ee}`);Q=((b=($=(O=(j=(K=(await V.json()).candidates)==null?void 0:K[0])==null?void 0:j.content)==null?void 0:O.parts)==null?void 0:$[0])==null?void 0:b.text)??""}else if(r==="claude"){const Ee=await fetch("https://api.anthropic.com/v1/messages",{method:"POST",headers:{"x-api-key":n,"anthropic-version":"2023-06-01","Content-Type":"application/json"},body:JSON.stringify({model:"claude-3-haiku-20240307",max_tokens:512,system:qu,messages:[{role:"user",content:t}]})});if(!Ee.ok)throw new Error(`Claude ${Ee.status}`);Q=((Z=(Y=(await Ee.json()).content)==null?void 0:Y[0])==null?void 0:Z.text)??""}const ge=Q.match(/\[[\s\S]*\]/);ge&&(M=JSON.parse(ge[0])),M!=null&&M.length?v=`// Generated by LLM agentic search
void run_pipeline(float* vertices, int count) {
${M.map(V=>{var ee;return V.type==="center"?"mesh_center(vertices, count);":V.type==="scale"?`mesh_scale(vertices, count, ${V.value}f);`:V.type==="translate"?`mesh_translate(vertices, count, ${(ee=V.vector)==null?void 0:ee.join("f, ")}f);`:V.type==="twist"?`mesh_twist(vertices, count, ${V.strength}f);`:""}).filter(Boolean).map(V=>"    "+V).join(`
`)}
}`:(v=Q||Ku,M=$u(t)),u("Pipeline generated by LLM.")}catch(Q){console.error("LLM error:",Q),u(`LLM error: ${Q.message} — using heuristic fallback.`),M=$u(t),v=Ku}a(v),D(M??$u(t))},I=async M=>{var K;const v=(K=M.target.files)==null?void 0:K[0];if(!v)return;const R=await v.text(),U=(v.name.toLowerCase().endsWith(".ply")?kw:Ow)(R);U?(h({vertices:U.vertices,faces:U.faces||[]}),u(`Loaded ${v.name} (${U.vertices.length/3} vertices).`)):u(`Could not parse ${v.name}.`)};return Et.useMemo(()=>!!d,[d]),et.jsxs("div",{className:"app-shell",children:[et.jsxs("div",{className:"panel",children:[et.jsx("h2",{children:"AI-Powered Geometry Pipeline"}),et.jsxs("div",{className:"grid",children:[et.jsxs("label",{children:["Prompt",et.jsx("textarea",{value:t,onChange:M=>e(M.target.value),placeholder:"Describe the geometry operation..."})]}),et.jsxs("label",{children:["API Provider",et.jsx("select",{value:r,onChange:M=>s(M.target.value),children:Zp.map(M=>et.jsx("option",{value:M.id,children:M.name},M.id))})]}),et.jsxs("label",{children:["API Key",et.jsx("input",{value:n,onChange:M=>i(M.target.value),type:"password"})]}),et.jsxs("label",{children:["Upload OBJ / PLY",et.jsx("input",{type:"file",accept:".obj,.ply",onChange:I})]})]}),et.jsxs("div",{className:"button-bar",children:[et.jsx("button",{onClick:A,children:"Generate Pipeline"}),et.jsx("button",{onClick:C,children:"Download USD"})]}),et.jsx("p",{className:"status",children:l})]}),et.jsxs("div",{className:"panel grid",children:[et.jsxs("div",{children:[et.jsx("h2",{children:"Generated C++ Pipeline"}),et.jsx("div",{className:"code-block",children:o||Ku})]}),et.jsxs("div",{children:[et.jsx("h2",{children:"Result Viewer"}),et.jsx("div",{ref:S,className:"viewer"})]})]})]})}Zu.createRoot(document.getElementById("root")).render(et.jsx(Bw,{}));
